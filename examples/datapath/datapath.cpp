...
void
datapath::handle_conn_established(
		rofl::crofctl& ctl,
		const rofl::cauxid& auxid)
{
	std::cerr << "connection established ctlid=" << ctlid.get_ctlid_s() << " auxid=" << (int)auxid.get_id() << std::endl;
}



void
datapath::handle_conn_terminated(
		rofl::crofctl& ctl,
		const rofl::cauxid& auxid)
{
...
void
datapath::handle_conn_negotiation_failed(
		rofl::crofctl& ctl,
		const rofl::cauxid& auxid)
{
...
void
datapath::handle_conn_congestion_occured(
		rofl::crofctl& ctl,
		const rofl::cauxid& auxid)
{
...
void
datapath::handle_conn_congestion_solved(
		rofl::crofctl& ctl,
		const rofl::cauxid& auxid)
{
...
void
datapath::handle_features_request(
		rofl::crofctl& ctl,
		const rofl::cauxid& auxid,
		rofl::openflow::cofmsg_features_request& msg)
{
	std::cerr << "received Features-Request ctlid=" << ctlid.get_ctlid_s() << " auxid=" << (int)auxid.get_id() << std::endl;
...
void
datapath::handle_port_desc_stats_request(
		rofl::crofctl& ctl,
		const rofl::cauxid& auxid,
		rofl::openflow::cofmsg_port_desc_stats_request& msg)
{
	std::cerr << "received Port-Desc-Stats-Request ctlid=" << ctlid.get_ctlid_s() << " auxid=" << (int)auxid.get_id() << std::endl;
...
void
datapath::handle_table_features_stats_request(
		rofl::crofctl& ctl,
		const rofl::cauxid& auxid,
		rofl::openflow::cofmsg_table_features_stats_request& msg)
{
	std::cerr << "received Table-Features-Stats-Request ctlid=" << ctlid.get_ctlid_s() << " auxid=" << (int)auxid.get_id() << std::endl;
...
void
datapath::handle_table_stats_request(
		rofl::crofctl& ctl,
		const rofl::cauxid& auxid,
		rofl::openflow::cofmsg_table_stats_request& msg)
{
	std::cerr << "received Table-Stats-Request ctlid=" << ctlid.get_ctlid_s() << " auxid=" << (int)auxid.get_id() << std::endl;
