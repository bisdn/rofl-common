...
void
coxmatch_test::test1ByteHasMaskExp()
{
	uint32_t oxm_id = oxm_id_exp | HAS_MASK_FLAG;
	const uint8_t *_oxm_id = (uint8_t *)&oxm_id;
	const uint8_t *_exp_id = (uint8_t *)&exp_id;
...
void
coxmatch_test::test2BytesHasMaskExp()
{
	uint32_t oxm_id = oxm_id_exp | HAS_MASK_FLAG;
	const uint8_t *_oxm_id = (uint8_t *)&oxm_id;
	const uint8_t *_exp_id = (uint8_t *)&exp_id;
...
void
coxmatch_test::test4BytesHasMaskExp()
{
	uint32_t oxm_id = oxm_id_exp | HAS_MASK_FLAG;
	const uint8_t *_oxm_id = (uint8_t *)&oxm_id;
	const uint8_t *_exp_id = (uint8_t *)&exp_id;
...
coxmatch_test::test6BytesExp()
{
	...
	CPPUNIT_ASSERT(mem == test);
	CPPUNIT_ASSERT(oxm.get_u48value() == rofl::cmacaddr("b1:b2:b3:b4:b5:b6").get_mac());
	CPPUNIT_ASSERT(oxm.get_u48mask() == rofl::cmacaddr("ff:ff:ff:ff:ff:ff").get_mac());
	CPPUNIT_ASSERT(oxm.get_u48masked_value() == rofl::cmacaddr("b1:b2:b3:b4:b5:b6").get_mac());

	oxm.set_u48value(rofl::cmacaddr("d1:d2:d3:d4:d5:d6").get_mac());

	CPPUNIT_ASSERT(oxm.get_u48value() == rofl::cmacaddr("d1:d2:d3:d4:d5:d6").get_mac());
}



void
coxmatch_test::test6BytesHasMaskExp()
{
	uint32_t oxm_id = oxm_id_exp | HAS_MASK_FLAG;
	const uint8_t *_oxm_id = (uint8_t *)&oxm_id;
	const uint8_t *_exp_id = (uint8_t *)&exp_id;
	...
	CPPUNIT_ASSERT(mem == test);
	CPPUNIT_ASSERT(oxm.get_u48value() == rofl::cmacaddr("b1:b2:b3:b4:b5:b6").get_mac());
	CPPUNIT_ASSERT(oxm.get_u48mask() == rofl::cmacaddr("c1:c2:c3:c4:c5:c6").get_mac());
	CPPUNIT_ASSERT(oxm.get_u48masked_value() == (rofl::cmacaddr("b1:b2:b3:b4:b5:b6").get_mac() &
			rofl::cmacaddr("c1:c2:c3:c4:c5:c6").get_mac()));

	oxm.set_u48value(rofl::cmacaddr("d1:d2:d3:d4:d5:d6").get_mac());
	oxm.set_u48mask(rofl::cmacaddr("e1:e2:e3:e4:e5:e6").get_mac());

	CPPUNIT_ASSERT(oxm.get_u48value() == rofl::cmacaddr("d1:d2:d3:d4:d5:d6").get_mac());
	CPPUNIT_ASSERT(oxm.get_u48mask() == rofl::cmacaddr("e1:e2:e3:e4:e5:e6").get_mac());
	CPPUNIT_ASSERT(oxm.get_u48masked_value() == (rofl::cmacaddr("d1:d2:d3:d4:d5:d6").get_mac() &
			rofl::cmacaddr("e1:e2:e3:e4:e5:e6").get_mac()));
}



void
coxmatch_test::test8BytesExp()
{
	uint32_t oxm_id = oxm_id_exp & ~HAS_MASK_FLAG;
	const uint8_t *_oxm_id = (uint8_t *)&oxm_id;
	const uint8_t *_exp_id = (uint8_t *)&exp_id;
...
void
coxmatch_test::test8BytesHasMaskExp()
{
	uint32_t oxm_id = oxm_id_exp | HAS_MASK_FLAG;
	const uint8_t *_oxm_id = (uint8_t *)&oxm_id;
	const uint8_t *_exp_id = (uint8_t *)&exp_id;
