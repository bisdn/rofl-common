...
void csegment_test::setUp() {}

void csegment_test::tearDown() {}

void csegment_test::testStoreAndMerge() {
  rofl::csegment segmsg(0x11121314, rofl::ctimespec().expire_in(8),
                        rofl::openflow::OFPT_MULTIPART_REPLY,
                        rofl::openflow::OFPMP_TABLE);
  ...
  msg1.set_table_stats_array().set_table_stats(0).set_lookup_count(
      0x2122232425262728);
  msg1.set_table_stats_array().set_table_stats(0).set_matched_count(
      0x3132333435363738);
  ...
  msg1.set_table_stats_array().set_table_stats(1).set_lookup_count(
      0x2122232425262728);
  msg1.set_table_stats_array().set_table_stats(1).set_matched_count(
      0x3132333435363738);
  ...
  msg2.set_table_stats_array().set_table_stats(4).set_lookup_count(
      0x2122232425262728);
  msg2.set_table_stats_array().set_table_stats(4).set_matched_count(
      0x3132333435363738);
  ...
  msg3.set_table_stats_array().set_table_stats(4).set_lookup_count(
      0x6162636465666768);
  msg3.set_table_stats_array().set_table_stats(4).set_matched_count(
      0x7172737475767778);
  ...
  msg3.set_table_stats_array().set_table_stats(8).set_lookup_count(
      0xb1b2b3b4b5b6b7b8);
  msg3.set_table_stats_array().set_table_stats(8).set_matched_count(
      0xc1c2c3c4c5c6c7c8);
  ...
  rofl::openflow::cofmsg_table_stats_reply merged =
      dynamic_cast<rofl::openflow::cofmsg_table_stats_reply const &>(
          segmsg.get_msg());

  CPPUNIT_ASSERT(merged.get_table_stats_array().size() == 4);
  CPPUNIT_ASSERT(merged.set_table_stats_array().set_table_stats(0) ==
                 msg1.get_table_stats_array().get_table_stats(0));
  CPPUNIT_ASSERT(merged.set_table_stats_array().set_table_stats(1) ==
                 msg1.get_table_stats_array().get_table_stats(1));
  CPPUNIT_ASSERT(not(merged.set_table_stats_array().set_table_stats(4) ==
                     msg2.get_table_stats_array().get_table_stats(4)));
  CPPUNIT_ASSERT(merged.set_table_stats_array().set_table_stats(4) ==
                 msg3.get_table_stats_array().get_table_stats(4));
  CPPUNIT_ASSERT(merged.set_table_stats_array().set_table_stats(8) ==
                 msg3.get_table_stats_array().get_table_stats(8));
}

void csegment_test::testRetrieveAndDetach() {
  rofl::csegment segmsg(0x11121314, rofl::ctimespec().expire_in(8),
                        rofl::openflow::OFPT_MULTIPART_REPLY,
                        rofl::openflow::OFPMP_TABLE);
  ...
  rofl::openflow::cofmsg_table_stats_reply *merged =
      dynamic_cast<rofl::openflow::cofmsg_table_stats_reply *>(
          segmsg.retrieve_and_detach_msg());
