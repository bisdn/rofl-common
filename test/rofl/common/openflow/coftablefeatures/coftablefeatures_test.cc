...
void coftablefeaturesTest::setUp() {}

void coftablefeaturesTest::tearDown() {}

void coftablefeaturesTest::testDefaultConstructor() {
  rofl::openflow::coftable_features table;
  CPPUNIT_ASSERT(rofl::openflow::OFP_VERSION_UNKNOWN == table.get_version());
}

void coftablefeaturesTest::testCopyConstructor() {
  ...
  table.set_properties().set_tfp_apply_actions().add_action(
      rofl::openflow13::OFPAT_SET_FIELD);
...
void coftablefeaturesTest::testPackUnpack() {
  rofl::openflow::coftable_features table(rofl::openflow13::OFP_VERSION);
