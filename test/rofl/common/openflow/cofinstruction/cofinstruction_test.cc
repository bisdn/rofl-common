...
void cofinstruction_test::setUp() {}

void cofinstruction_test::tearDown() {}

void cofinstruction_test::test_cofinstruction() {
...
void cofinstruction_test::test_cofinstruction_goto_table() {
  rofl::openflow::cofinstruction_goto_table inst;
  CPPUNIT_ASSERT(rofl::openflow::OFP_VERSION_UNKNOWN == inst.get_version());

  uint8_t table_id = 8;

  inst = rofl::openflow::cofinstruction_goto_table(
      rofl::openflow13::OFP_VERSION, table_id);
  ...
  CPPUNIT_ASSERT(packed.memlen() ==
                 sizeof(struct rofl::openflow13::ofp_instruction_goto_table));
  CPPUNIT_ASSERT(packed[0] == 0x00);
  CPPUNIT_ASSERT(packed[1] == rofl::openflow13::OFPIT_GOTO_TABLE);
  CPPUNIT_ASSERT(packed[2] == 0x00);
  CPPUNIT_ASSERT(packed[3] ==
                 sizeof(struct rofl::openflow13::ofp_instruction_goto_table));
  CPPUNIT_ASSERT(packed[4] == table_id);

  rofl::openflow::cofinstruction_goto_table clone(
...
void cofinstruction_test::test_cofinstruction_apply_actions() {
  rofl::cindex index(0);
  ...
  inst = rofl::openflow::cofinstruction_apply_actions(
      rofl::openflow13::OFP_VERSION, actions);
  ...
  rofl::openflow::cofinstruction_apply_actions clone(
      rofl::openflow13::OFP_VERSION);
  clone.unpack(packed.somem(), packed.memlen());
...
void cofinstruction_test::test_cofinstruction_write_actions() {
  rofl::cindex index(0);
  ...
  inst = rofl::openflow::cofinstruction_write_actions(
      rofl::openflow13::OFP_VERSION, actions);
  ...
  rofl::openflow::cofinstruction_write_actions clone(
      rofl::openflow13::OFP_VERSION);
  clone.unpack(packed.somem(), packed.memlen());
...
void cofinstruction_test::test_cofinstruction_clear_actions() {
  rofl::openflow::cofinstruction_clear_actions inst;
  CPPUNIT_ASSERT(rofl::openflow::OFP_VERSION_UNKNOWN == inst.get_version());

  inst = rofl::openflow::cofinstruction_clear_actions(
      rofl::openflow13::OFP_VERSION);
  ...
  rofl::openflow::cofinstruction_clear_actions clone(
      rofl::openflow13::OFP_VERSION);
  clone.unpack(packed.somem(), packed.memlen());
...
void cofinstruction_test::test_cofinstruction_write_metadata() {
  ...
  inst = rofl::openflow::cofinstruction_write_metadata(
      rofl::openflow13::OFP_VERSION, metadata, metadata_mask);
  ...
  CPPUNIT_ASSERT(
      packed.memlen() ==
      sizeof(struct rofl::openflow13::ofp_instruction_write_metadata));
  CPPUNIT_ASSERT(packed[0] == 0x00);
  ...
  rofl::openflow::cofinstruction_write_metadata clone(
      rofl::openflow13::OFP_VERSION);
  clone.unpack(packed.somem(), packed.memlen());
...
void cofinstruction_test::test_cofinstruction_meter() {
  rofl::openflow::cofinstruction_meter inst;
  CPPUNIT_ASSERT(rofl::openflow::OFP_VERSION_UNKNOWN == inst.get_version());

  uint32_t meter_id = 0xa1a2a3a4;

  inst = rofl::openflow::cofinstruction_meter(rofl::openflow13::OFP_VERSION,
                                              meter_id);
  ...
  CPPUNIT_ASSERT(packed.memlen() ==
                 sizeof(struct rofl::openflow13::ofp_instruction_meter));
  CPPUNIT_ASSERT(packed[0] == 0x00);
...
void cofinstruction_test::test_cofinstruction_experimenter() {
  ...
  inst = rofl::openflow::cofinstruction_experimenter(
      rofl::openflow13::OFP_VERSION, exp_id, body);
  ...
  rofl::openflow::cofinstruction_experimenter clone(
      rofl::openflow13::OFP_VERSION);
  clone.unpack(packed.somem(), packed.memlen());
