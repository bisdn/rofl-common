...
void cofactions_test::setUp() {}

void cofactions_test::tearDown() {}

void cofactions_test::testActions() {
  rofl::cindex index(0);
  ...
  actions.add_action_set_field(index++).set_oxm(
      rofl::openflow::coxmatch_ofb_eth_dst(
          rofl::caddress_ll("a0:a1:a2:a3:a4:a5")));
  actions.add_action_set_field(index++).set_oxm(
      rofl::openflow::coxmatch_ofb_eth_src(
          rofl::caddress_ll("b0:b1:b2:b3:b4:b5")));
  actions.add_action_set_field(index++).set_oxm(
      rofl::openflow::coxmatch_ofb_eth_type(0xc1c2));
