...
void cofasyncconfig_test::setUp() {}

void cofasyncconfig_test::tearDown() {}

void cofasyncconfig_test::testDefaultConstructor() {
  rofl::openflow::cofasync_config ac;
  CPPUNIT_ASSERT(rofl::openflow::OFP_VERSION_UNKNOWN == ac.get_version());
}

void cofasyncconfig_test::testCopyConstructor() {
...
void cofasyncconfig_test::testPackUnpack() {
  /*
   * pack
   */
  rofl::openflow::cofasync_config ac(rofl::openflow13::OFP_VERSION);
  ...
  struct rofl::openflow::cofasync_config::async_config_t *async =
      (struct rofl::openflow::cofasync_config::async_config_t *)mac.somem();
