...
class cofmsgtablemodtest : public CppUnit::TestFixture {
...
private:
  void testTableMod(uint8_t version, uint8_t type, uint32_t xid);
  void testTableModParser(uint8_t version, uint8_t type, uint32_t xid);
};
