...
void
cofmsgmeterfeaturesstatstest::setUp()
{}



void
cofmsgmeterfeaturesstatstest::tearDown()
{}



void
cofmsgmeterfeaturesstatstest::testRequest13()
{
	testRequest(
			rofl::openflow13::OFP_VERSION,
			rofl::openflow13::OFPT_MULTIPART_REQUEST,
			0xa1a2a3a4,
			rofl::openflow13::OFPMP_METER_FEATURES,
			0xb1b2);
}
...
void
cofmsgmeterfeaturesstatstest::testRequest(
		uint8_t version, uint8_t type, uint32_t xid, uint16_t stats_type, uint16_t stats_flags)
{
	rofl::openflow::cofmsg_meter_features_stats_request msg1(version, xid, stats_flags);
...
void
cofmsgmeterfeaturesstatstest::testReply13()
{
	testReply(
			rofl::openflow13::OFP_VERSION,
...
void
cofmsgmeterfeaturesstatstest::testReply(
		uint8_t version, uint8_t type, uint32_t xid, uint16_t stats_type, uint16_t stats_flags)
{
	rofl::openflow::cofmsg_meter_features_stats_reply msg1(version, xid, stats_flags);
...
void
cofmsgmeterfeaturesstatstest::testRequestParser13()
{
...
void
cofmsgmeterfeaturesstatstest::testReplyParser13()
{
	uint8_t version = rofl::openflow13::OFP_VERSION;
	...
	size_t msglen = sizeof(struct rofl::openflow13::ofp_multipart_request) + meterfeatures.length();
	size_t memlen = msglen + /*test overhead*/4;
