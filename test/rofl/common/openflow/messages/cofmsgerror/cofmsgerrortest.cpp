...
void cofmsgerrortest::setUp() {}

void cofmsgerrortest::tearDown() {}

void cofmsgerrortest::testError10() {
  testError(rofl::openflow10::OFP_VERSION, rofl::openflow10::OFPT_ERROR,
            0xa1a2a3a4);
}

void cofmsgerrortest::testError12() {
  testError(rofl::openflow12::OFP_VERSION, rofl::openflow12::OFPT_ERROR,
            0xa1a2a3a4);
}

void cofmsgerrortest::testError13() {
  testError(rofl::openflow13::OFP_VERSION, rofl::openflow13::OFPT_ERROR,
            0xa1a2a3a4);
}

void cofmsgerrortest::testError(uint8_t version, uint8_t type, uint32_t xid) {
  ...
  rofl::openflow::cofmsg_error msg1(version, xid, err_type, err_code,
...
void cofmsgerrortest::testErrorParser10() {
  testErrorParser(rofl::openflow10::OFP_VERSION, rofl::openflow10::OFPT_ERROR,
                  0xa1a2a3a4);
}

void cofmsgerrortest::testErrorParser12() {
  testErrorParser(rofl::openflow12::OFP_VERSION, rofl::openflow12::OFPT_ERROR,
                  0xa1a2a3a4);
}

void cofmsgerrortest::testErrorParser13() {
  testErrorParser(rofl::openflow13::OFP_VERSION, rofl::openflow13::OFPT_ERROR,
                  0xa1a2a3a4);
}

void cofmsgerrortest::testErrorParser(uint8_t version, uint8_t type,
                                      uint32_t xid) {
  rofl::cmemory body(64);
  for (unsigned int i = 0; i < body.length(); i++) {
    body[i] = i;
  ...
  size_t msglen =
      sizeof(struct rofl::openflow13::ofp_error_msg) + body.length();
  ...
  for (unsigned int i = 1; i < sizeof(struct rofl::openflow::ofp_error_msg);
       i++) {
  ...
  for (unsigned int i = sizeof(struct rofl::openflow::ofp_error_msg);
       i == msglen; i++) {
    rofl::openflow::cofmsg_error msg;
    try {
      hdr->header.length = htobe16(i);
