/*
 * cofmsgqueuestatstest.hpp
 *
 *  Created on: Apr 26, 2015
 *      Author: andi
 */

#ifndef TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGQUEUESTATS_TEST_HPP_
#define TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGQUEUESTATS_TEST_HPP_
...
class cofmsgqueuestatstest : public CppUnit::TestFixture {
  CPPUNIT_TEST_SUITE(cofmsgqueuestatstest);
...
#endif /* TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGQUEUESTATS_TEST_HPP_ */
