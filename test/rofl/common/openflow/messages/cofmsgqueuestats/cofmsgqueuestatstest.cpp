...
void cofmsgqueuestatstest::setUp() {}

void cofmsgqueuestatstest::tearDown() {}

void cofmsgqueuestatstest::testRequest10() {
  testRequest(rofl::openflow10::OFP_VERSION,
              rofl::openflow10::OFPT_STATS_REQUEST, 0xa1a2a3a4,
              rofl::openflow10::OFPST_QUEUE, 0xb1b2);
}

void cofmsgqueuestatstest::testRequest12() {
  testRequest(rofl::openflow12::OFP_VERSION,
              rofl::openflow12::OFPT_STATS_REQUEST, 0xa1a2a3a4,
              rofl::openflow12::OFPST_QUEUE, 0xb1b2);
}

void cofmsgqueuestatstest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_MULTIPART_REQUEST, 0xa1a2a3a4,
              rofl::openflow13::OFPMP_QUEUE, 0xb1b2);
}

void cofmsgqueuestatstest::testRequest(uint8_t version, uint8_t type,
...
void cofmsgqueuestatstest::testReply10() {
  testReply(rofl::openflow10::OFP_VERSION, rofl::openflow10::OFPT_STATS_REPLY,
            0xa1a2a3a4, rofl::openflow10::OFPST_QUEUE, 0xb1b2);
}

void cofmsgqueuestatstest::testReply12() {
  testReply(rofl::openflow12::OFP_VERSION, rofl::openflow12::OFPT_STATS_REPLY,
            0xa1a2a3a4, rofl::openflow12::OFPST_QUEUE, 0xb1b2);
}

void cofmsgqueuestatstest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION,
            rofl::openflow13::OFPT_MULTIPART_REPLY, 0xa1a2a3a4,
            rofl::openflow13::OFPMP_QUEUE, 0xb1b2);
}

void cofmsgqueuestatstest::testReply(uint8_t version, uint8_t type,
                                     uint32_t xid, uint16_t stats_type,
                                     uint16_t stats_flags) {
...
void cofmsgqueuestatstest::testRequestParser10() {
  ...
  size_t msglen =
      sizeof(struct rofl::openflow10::ofp_stats_request) + queue.length();
...
void cofmsgqueuestatstest::testRequestParser12() {
  ...
  size_t msglen =
      sizeof(struct rofl::openflow12::ofp_stats_request) + queue.length();
  size_t memlen = msglen + /*test overhead*/ 4;
...
void cofmsgqueuestatstest::testRequestParser13() {
  ...
  size_t msglen =
      sizeof(struct rofl::openflow13::ofp_multipart_request) + queue.length();
  size_t memlen = msglen + /*test overhead*/ 4;
...
void cofmsgqueuestatstest::testReplyParser10() {
  uint8_t version = rofl::openflow10::OFP_VERSION;
...
void cofmsgqueuestatstest::testReplyParser12() {
  uint8_t version = rofl::openflow12::OFP_VERSION;
  uint64_t tx_bytes = 0x4142434445464748;
  uint64_t tx_packets = 0x6162636465666768;
  uint32_t queueid = 0xc1c2c3c4;
...
void cofmsgqueuestatstest::testReplyParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
  uint64_t tx_bytes = 0x4142434445464748;
  uint64_t tx_packets = 0x6162636465666768;
  uint32_t queueid = 0xc1c2c3c4;
