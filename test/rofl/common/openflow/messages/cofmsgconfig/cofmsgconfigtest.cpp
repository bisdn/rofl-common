...
void cofmsgconfigtest::setUp() {}

void cofmsgconfigtest::tearDown() {}

void cofmsgconfigtest::testRequest10() {
  testRequest(rofl::openflow10::OFP_VERSION,
              rofl::openflow10::OFPT_GET_CONFIG_REQUEST, 0xa1a2a3a4);
}

void cofmsgconfigtest::testRequest12() {
  testRequest(rofl::openflow12::OFP_VERSION,
              rofl::openflow12::OFPT_GET_CONFIG_REQUEST, 0xa1a2a3a4);
}

void cofmsgconfigtest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_GET_CONFIG_REQUEST, 0xa1a2a3a4);
}

void cofmsgconfigtest::testRequest(uint8_t version, uint8_t type,
                                   uint32_t xid) {
...
void cofmsgconfigtest::testReply10() {
  testReply(rofl::openflow10::OFP_VERSION,
            rofl::openflow10::OFPT_GET_CONFIG_REPLY, 0xa1a2a3a4);
}

void cofmsgconfigtest::testReply12() {
  testReply(rofl::openflow12::OFP_VERSION,
            rofl::openflow12::OFPT_GET_CONFIG_REPLY, 0xa1a2a3a4);
}

void cofmsgconfigtest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION,
            rofl::openflow13::OFPT_GET_CONFIG_REPLY, 0xa1a2a3a4);
}

void cofmsgconfigtest::testReply(uint8_t version, uint8_t type, uint32_t xid) {
...
void cofmsgconfigtest::testSet10() {
  testSet(rofl::openflow10::OFP_VERSION, rofl::openflow10::OFPT_SET_CONFIG,
          0xa1a2a3a4);
}

void cofmsgconfigtest::testSet12() {
  testSet(rofl::openflow12::OFP_VERSION, rofl::openflow12::OFPT_SET_CONFIG,
          0xa1a2a3a4);
}

void cofmsgconfigtest::testSet13() {
  testSet(rofl::openflow13::OFP_VERSION, rofl::openflow13::OFPT_SET_CONFIG,
          0xa1a2a3a4);
}

void cofmsgconfigtest::testSet(uint8_t version, uint8_t type, uint32_t xid) {
...
void cofmsgconfigtest::testRequestParser10() {
...
void cofmsgconfigtest::testRequestParser12() {
...
void cofmsgconfigtest::testRequestParser13() {
...
void cofmsgconfigtest::testReplyParser10() {
  uint8_t version = rofl::openflow10::OFP_VERSION;
  uint16_t flags = 0xc1c2;
  uint16_t miss_send_len = 0xd1d2;
...
void cofmsgconfigtest::testReplyParser12() {
  uint8_t version = rofl::openflow12::OFP_VERSION;
  uint16_t flags = 0xc1c2;
  uint16_t miss_send_len = 0xd1d2;
...
void cofmsgconfigtest::testReplyParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
  uint16_t flags = 0xc1c2;
  uint16_t miss_send_len = 0xd1d2;
...
void cofmsgconfigtest::testSetParser10() {
  uint8_t version = rofl::openflow10::OFP_VERSION;
  uint16_t flags = 0xc1c2;
  uint16_t miss_send_len = 0xd1d2;
...
void cofmsgconfigtest::testSetParser12() {
  uint8_t version = rofl::openflow12::OFP_VERSION;
  uint16_t flags = 0xc1c2;
  uint16_t miss_send_len = 0xd1d2;
...
void cofmsgconfigtest::testSetParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
  uint16_t flags = 0xc1c2;
  uint16_t miss_send_len = 0xd1d2;
