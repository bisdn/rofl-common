...
void cofmsgdescstatstest::setUp() {}

void cofmsgdescstatstest::tearDown() {}

void cofmsgdescstatstest::testRequest10() {
  testRequest(rofl::openflow10::OFP_VERSION,
              rofl::openflow10::OFPT_STATS_REQUEST, 0xa1a2a3a4,
              rofl::openflow10::OFPST_DESC, 0xb1b2);
}

void cofmsgdescstatstest::testRequest12() {
  testRequest(rofl::openflow12::OFP_VERSION,
              rofl::openflow12::OFPT_STATS_REQUEST, 0xa1a2a3a4,
              rofl::openflow12::OFPST_DESC, 0xb1b2);
}

void cofmsgdescstatstest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_MULTIPART_REQUEST, 0xa1a2a3a4,
              rofl::openflow13::OFPMP_DESC, 0xb1b2);
}

void cofmsgdescstatstest::testRequest(uint8_t version, uint8_t type,
...
void cofmsgdescstatstest::testReply10() {
  testReply(rofl::openflow10::OFP_VERSION, rofl::openflow10::OFPT_STATS_REPLY,
            0xa1a2a3a4, rofl::openflow10::OFPST_DESC, 0xb1b2);
}

void cofmsgdescstatstest::testReply12() {
  testReply(rofl::openflow12::OFP_VERSION, rofl::openflow12::OFPT_STATS_REPLY,
            0xa1a2a3a4, rofl::openflow12::OFPST_DESC, 0xb1b2);
}

void cofmsgdescstatstest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION,
            rofl::openflow13::OFPT_MULTIPART_REPLY, 0xa1a2a3a4,
            rofl::openflow13::OFPMP_DESC, 0xb1b2);
}

void cofmsgdescstatstest::testReply(uint8_t version, uint8_t type, uint32_t xid,
...
void cofmsgdescstatstest::testRequestParser10() {
...
void cofmsgdescstatstest::testRequestParser12() {
...
void cofmsgdescstatstest::testRequestParser13() {
...
void cofmsgdescstatstest::testReplyParser10() {
  uint8_t version = rofl::openflow10::OFP_VERSION;
  ...
  cofdesc_stats_reply desc(version, mfr_desc, hw_desc, sw_desc, serial_num,
                           dp_desc);

  size_t msglen =
      sizeof(struct rofl::openflow10::ofp_stats_request) + desc.length();
  size_t memlen = msglen + /*test overhead*/ 4;
...
void cofmsgdescstatstest::testReplyParser12() {
  uint8_t version = rofl::openflow12::OFP_VERSION;
  std::string mfr_desc("mrf_desc");
  std::string hw_desc("hw_desc");
  std::string sw_desc("sw_desc");
  ...
  size_t msglen =
      sizeof(struct rofl::openflow12::ofp_stats_request) + desc.length();
  size_t memlen = msglen + /*test overhead*/ 4;
...
void cofmsgdescstatstest::testReplyParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
  std::string mfr_desc("mrf_desc");
  std::string hw_desc("hw_desc");
  std::string sw_desc("sw_desc");
  ...
  size_t msglen =
      sizeof(struct rofl::openflow13::ofp_multipart_request) + desc.length();
  size_t memlen = msglen + /*test overhead*/ 4;
