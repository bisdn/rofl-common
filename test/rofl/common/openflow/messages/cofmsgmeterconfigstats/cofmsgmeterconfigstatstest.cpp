...
void cofmsgmeterconfigstatstest::setUp() {}

void cofmsgmeterconfigstatstest::tearDown() {}

void cofmsgmeterconfigstatstest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_MULTIPART_REQUEST, 0xa1a2a3a4,
              rofl::openflow13::OFPMP_METER_CONFIG, 0xb1b2);
}

void cofmsgmeterconfigstatstest::testRequest(uint8_t version, uint8_t type,
                                             uint32_t xid, uint16_t stats_type,
                                             uint16_t stats_flags) {
  rofl::openflow::cofmsg_meter_config_stats_request msg1(version, xid,
                                                         stats_flags);
...
void cofmsgmeterconfigstatstest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION,
            rofl::openflow13::OFPT_MULTIPART_REPLY, 0xa1a2a3a4,
            rofl::openflow13::OFPMP_METER_CONFIG, 0xb1b2);
}

void cofmsgmeterconfigstatstest::testReply(uint8_t version, uint8_t type,
                                           uint32_t xid, uint16_t stats_type,
                                           uint16_t stats_flags) {
  rofl::openflow::cofmsg_meter_config_stats_reply msg1(version, xid,
                                                       stats_flags);
...
void cofmsgmeterconfigstatstest::testRequestParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
  uint32_t port_no = 0xd0d1d2d3;

  cofmeter_config_request meterconfig(version, port_no);
...
void cofmsgmeterconfigstatstest::testReplyParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
