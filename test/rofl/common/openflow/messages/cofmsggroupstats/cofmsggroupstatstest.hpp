/*
 * cofmsggroupstatstest.hpp
 *
 *  Created on: Apr 26, 2015
 *      Author: andi
 */

#ifndef TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGGROUPSTATS_TEST_HPP_
#define TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGGROUPSTATS_TEST_HPP_
...
class cofmsggroupstatstest : public CppUnit::TestFixture {
  CPPUNIT_TEST_SUITE(cofmsggroupstatstest);
...
#endif /* TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGGROUPSTATS_TEST_HPP_ */
