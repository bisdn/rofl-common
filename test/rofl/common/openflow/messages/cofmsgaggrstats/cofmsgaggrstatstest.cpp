...
void cofmsgaggrstatstest::setUp() {}

void cofmsgaggrstatstest::tearDown() {}

void cofmsgaggrstatstest::testRequest10() {
  testRequest(rofl::openflow10::OFP_VERSION,
              rofl::openflow10::OFPT_STATS_REQUEST, 0xa1a2a3a4,
              rofl::openflow10::OFPST_AGGREGATE, 0xb1b2);
}

void cofmsgaggrstatstest::testRequest12() {
  testRequest(rofl::openflow12::OFP_VERSION,
              rofl::openflow12::OFPT_STATS_REQUEST, 0xa1a2a3a4,
              rofl::openflow12::OFPST_AGGREGATE, 0xb1b2);
}

void cofmsgaggrstatstest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_MULTIPART_REQUEST, 0xa1a2a3a4,
              rofl::openflow13::OFPMP_AGGREGATE, 0xb1b2);
}

void cofmsgaggrstatstest::testRequest(uint8_t version, uint8_t type,
...
void cofmsgaggrstatstest::testReply10() {
  testReply(rofl::openflow10::OFP_VERSION, rofl::openflow10::OFPT_STATS_REPLY,
            0xa1a2a3a4, rofl::openflow10::OFPST_AGGREGATE, 0xb1b2);
}

void cofmsgaggrstatstest::testReply12() {
  testReply(rofl::openflow12::OFP_VERSION, rofl::openflow12::OFPT_STATS_REPLY,
            0xa1a2a3a4, rofl::openflow12::OFPST_AGGREGATE, 0xb1b2);
}

void cofmsgaggrstatstest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION,
            rofl::openflow13::OFPT_MULTIPART_REPLY, 0xa1a2a3a4,
            rofl::openflow13::OFPMP_AGGREGATE, 0xb1b2);
}

void cofmsgaggrstatstest::testReply(uint8_t version, uint8_t type, uint32_t xid,
...
void cofmsgaggrstatstest::testRequestParser10() {
  ...
  cofaggr_stats_request aggr(version, match, table_id, out_port);

  size_t msglen =
      sizeof(struct rofl::openflow10::ofp_stats_request) + aggr.length();
...
void cofmsgaggrstatstest::testRequestParser12() {
  ...
  size_t msglen =
      sizeof(struct rofl::openflow12::ofp_stats_request) + aggr.length();
  size_t memlen = msglen + /*test overhead*/ 4;
...
void cofmsgaggrstatstest::testRequestParser13() {
  ...
  size_t msglen =
      sizeof(struct rofl::openflow13::ofp_multipart_request) + aggr.length();
  size_t memlen = msglen + /*test overhead*/ 4;
...
void cofmsgaggrstatstest::testReplyParser10() {
  uint8_t version = rofl::openflow10::OFP_VERSION;
  uint64_t packet_count = 0xa0a1a2a3a4a5a6a7;
  uint64_t byte_count = 0xb0b1b2b3b4b5b6b7;
  uint32_t flow_count = 0xc0c1c2c3;

  cofaggr_stats_reply aggr(version, packet_count, byte_count, flow_count);
...
void cofmsgaggrstatstest::testReplyParser12() {
  uint8_t version = rofl::openflow12::OFP_VERSION;
  uint64_t packet_count = 0xa0a1a2a3a4a5a6a7;
  uint64_t byte_count = 0xb0b1b2b3b4b5b6b7;
  uint32_t flow_count = 0xc0c1c2c3;
...
void cofmsgaggrstatstest::testReplyParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
  uint64_t packet_count = 0xa0a1a2a3a4a5a6a7;
  uint64_t byte_count = 0xb0b1b2b3b4b5b6b7;
  uint32_t flow_count = 0xc0c1c2c3;
