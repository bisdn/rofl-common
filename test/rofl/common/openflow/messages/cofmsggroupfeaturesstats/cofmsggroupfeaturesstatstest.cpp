...
void
cofmsggroupfeaturesstatstest::setUp()
{}



void
cofmsggroupfeaturesstatstest::tearDown()
{}



void
cofmsggroupfeaturesstatstest::testRequest12()
{
	testRequest(
			rofl::openflow12::OFP_VERSION,
			rofl::openflow12::OFPT_STATS_REQUEST,
			0xa1a2a3a4,
			rofl::openflow12::OFPST_GROUP_FEATURES,
			0xb1b2);
}
...
void
cofmsggroupfeaturesstatstest::testRequest13()
{
	testRequest(
			rofl::openflow13::OFP_VERSION,
			rofl::openflow13::OFPT_MULTIPART_REQUEST,
			0xa1a2a3a4,
			rofl::openflow13::OFPMP_GROUP_FEATURES,
			0xb1b2);
}
...
void
cofmsggroupfeaturesstatstest::testRequest(
		uint8_t version, uint8_t type, uint32_t xid, uint16_t stats_type, uint16_t stats_flags)
{
	rofl::openflow::cofmsg_group_features_stats_request msg1(version, xid, stats_flags);
...
void
cofmsggroupfeaturesstatstest::testReply12()
{
	testReply(
			rofl::openflow12::OFP_VERSION,
...
void
cofmsggroupfeaturesstatstest::testReply13()
{
	testReply(
			rofl::openflow13::OFP_VERSION,
...
void
cofmsggroupfeaturesstatstest::testReply(
		uint8_t version, uint8_t type, uint32_t xid, uint16_t stats_type, uint16_t stats_flags)
{
	rofl::openflow::cofmsg_group_features_stats_reply msg1(version, xid, stats_flags);
...
void
cofmsggroupfeaturesstatstest::testRequestParser12()
{
...
void
cofmsggroupfeaturesstatstest::testRequestParser13()
{
...
void
cofmsggroupfeaturesstatstest::testReplyParser12()
{
	uint8_t version = rofl::openflow12::OFP_VERSION;

	cofgroup_features_stats_reply groupfeatures(version);

	size_t msglen = sizeof(struct rofl::openflow12::ofp_stats_reply) + groupfeatures.length();
	size_t memlen = msglen + /*test overhead*/4;
...
void
cofmsggroupfeaturesstatstest::testReplyParser13()
{
	uint8_t version = rofl::openflow13::OFP_VERSION;

	cofgroup_features_stats_reply groupfeatures(version);

	size_t msglen = sizeof(struct rofl::openflow13::ofp_multipart_reply) + groupfeatures.length();
	size_t memlen = msglen + /*test overhead*/4;
