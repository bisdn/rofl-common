...
#ifndef TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGTABLEFEATURESSTATS_TEST_HPP_
#define TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGTABLEFEATURESSTATS_TEST_HPP_
...
class cofmsgtablefeaturesstatstest : public CppUnit::TestFixture {
  CPPUNIT_TEST_SUITE(cofmsgtablefeaturesstatstest);
...
#endif /* TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGTABLEFEATURESSTATS_TEST_HPP_ \
          */
