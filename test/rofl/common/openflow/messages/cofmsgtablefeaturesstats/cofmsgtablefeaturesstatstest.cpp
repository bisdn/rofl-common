/*
 * cofmsgtablefeaturesstatstest.cpp
 *
...
#include "cofmsgtablefeaturesstatstest.hpp"

using namespace rofl::openflow;

CPPUNIT_TEST_SUITE_REGISTRATION(cofmsgtablefeaturesstatstest);

void cofmsgtablefeaturesstatstest::setUp() {}

void cofmsgtablefeaturesstatstest::tearDown() {}

void cofmsgtablefeaturesstatstest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_MULTIPART_REQUEST, 0xa1a2a3a4,
              rofl::openflow13::OFPMP_TABLE_FEATURES, 0xb1b2);
}

void cofmsgtablefeaturesstatstest::testRequest(uint8_t version, uint8_t type,
                                               uint32_t xid,
                                               uint16_t stats_type,
                                               uint16_t stats_flags) {
  rofl::openflow::cofmsg_table_features_stats_request msg1(version, xid,
                                                           stats_flags);
  rofl::openflow::cofmsg_table_features_stats_request msg2;
...
void cofmsgtablefeaturesstatstest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION,
            rofl::openflow13::OFPT_MULTIPART_REPLY, 0xa1a2a3a4,
            rofl::openflow13::OFPMP_TABLE_FEATURES, 0xb1b2);
}

void cofmsgtablefeaturesstatstest::testReply(uint8_t version, uint8_t type,
                                             uint32_t xid, uint16_t stats_type,
                                             uint16_t stats_flags) {
  rofl::openflow::cofmsg_table_features_stats_reply msg1(version, xid,
                                                         stats_flags);
...
void cofmsgtablefeaturesstatstest::testRequestParser13() {
...
void cofmsgtablefeaturesstatstest::testReplyParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
