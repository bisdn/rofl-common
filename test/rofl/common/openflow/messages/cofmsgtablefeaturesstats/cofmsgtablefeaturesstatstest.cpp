...
void
cofmsgtablefeaturesstatstest::setUp()
{}



void
cofmsgtablefeaturesstatstest::tearDown()
{}



void
cofmsgtablefeaturesstatstest::testRequest13()
{
	testRequest(
...
void
cofmsgtablefeaturesstatstest::testRequest(
		uint8_t version, uint8_t type, uint32_t xid, uint16_t stats_type, uint16_t stats_flags)
{
	rofl::openflow::cofmsg_table_features_stats_request msg1(version, xid, stats_flags);
...
void
cofmsgtablefeaturesstatstest::testReply13()
{
	testReply(
			rofl::openflow13::OFP_VERSION,
...
void
cofmsgtablefeaturesstatstest::testReply(
		uint8_t version, uint8_t type, uint32_t xid, uint16_t stats_type, uint16_t stats_flags)
{
...
void
cofmsgtablefeaturesstatstest::testRequestParser13()
{
...
void
cofmsgtablefeaturesstatstest::testReplyParser13()
{
	uint8_t version = rofl::openflow13::OFP_VERSION;
