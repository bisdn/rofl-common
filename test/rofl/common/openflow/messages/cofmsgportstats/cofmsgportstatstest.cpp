...
void cofmsgportstatstest::setUp() {}

void cofmsgportstatstest::tearDown() {}

void cofmsgportstatstest::testRequest10() {
  testRequest(rofl::openflow10::OFP_VERSION,
              rofl::openflow10::OFPT_STATS_REQUEST, 0xa1a2a3a4,
              rofl::openflow10::OFPST_PORT, 0xb1b2);
}

void cofmsgportstatstest::testRequest12() {
  testRequest(rofl::openflow12::OFP_VERSION,
              rofl::openflow12::OFPT_STATS_REQUEST, 0xa1a2a3a4,
              rofl::openflow12::OFPST_PORT, 0xb1b2);
}

void cofmsgportstatstest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_MULTIPART_REQUEST, 0xa1a2a3a4,
              rofl::openflow13::OFPMP_PORT_STATS, 0xb1b2);
}

void cofmsgportstatstest::testRequest(uint8_t version, uint8_t type,
...
void cofmsgportstatstest::testReply10() {
  testReply(rofl::openflow10::OFP_VERSION, rofl::openflow10::OFPT_STATS_REPLY,
            0xa1a2a3a4, rofl::openflow10::OFPST_PORT, 0xb1b2);
}

void cofmsgportstatstest::testReply12() {
  testReply(rofl::openflow12::OFP_VERSION, rofl::openflow12::OFPT_STATS_REPLY,
            0xa1a2a3a4, rofl::openflow12::OFPST_PORT, 0xb1b2);
}

void cofmsgportstatstest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION,
            rofl::openflow13::OFPT_MULTIPART_REPLY, 0xa1a2a3a4,
            rofl::openflow13::OFPMP_PORT_STATS, 0xb1b2);
}

void cofmsgportstatstest::testReply(uint8_t version, uint8_t type, uint32_t xid,
...
void cofmsgportstatstest::testRequestParser10() {
  ...
  size_t msglen =
      sizeof(struct rofl::openflow10::ofp_stats_request) + port.length();
...
void cofmsgportstatstest::testRequestParser12() {
  ...
  size_t msglen =
      sizeof(struct rofl::openflow12::ofp_stats_request) + port.length();
  size_t memlen = msglen + /*test overhead*/ 4;
...
void cofmsgportstatstest::testRequestParser13() {
  ...
  size_t msglen =
      sizeof(struct rofl::openflow13::ofp_multipart_request) + port.length();
  size_t memlen = msglen + /*test overhead*/ 4;
...
void cofmsgportstatstest::testReplyParser10() {
  uint8_t version = rofl::openflow10::OFP_VERSION;
...
void cofmsgportstatstest::testReplyParser12() {
  uint8_t version = rofl::openflow12::OFP_VERSION;
  uint64_t rx_bytes = 0x4142434445464748;
  uint64_t tx_packets = 0x6162636465666768;
...
void cofmsgportstatstest::testReplyParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
  uint64_t rx_bytes = 0x4142434445464748;
  uint64_t tx_packets = 0x6162636465666768;
  ...
  size_t memlen =
      msglen + ports.length() + ports.length() + /*test overhead*/ 4;
