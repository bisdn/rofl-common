...
void
cofmsgtablestatstest::setUp()
{}



void
cofmsgtablestatstest::tearDown()
{}



void
cofmsgtablestatstest::testRequest10()
{
	testRequest(
			rofl::openflow10::OFP_VERSION,
			rofl::openflow10::OFPT_STATS_REQUEST,
			0xa1a2a3a4,
			rofl::openflow10::OFPST_TABLE,
			0xb1b2);
}
...
void
cofmsgtablestatstest::testRequest12()
{
	testRequest(
			rofl::openflow12::OFP_VERSION,
			rofl::openflow12::OFPT_STATS_REQUEST,
			0xa1a2a3a4,
			rofl::openflow12::OFPST_TABLE,
			0xb1b2);
}
...
void
cofmsgtablestatstest::testRequest(
...
void
cofmsgtablestatstest::testReply10()
{
	testReply(
			rofl::openflow10::OFP_VERSION,
...
void
cofmsgtablestatstest::testReply12()
{
	testReply(
			rofl::openflow12::OFP_VERSION,
...
void
cofmsgtablestatstest::testReply13()
{
	testReply(
			rofl::openflow13::OFP_VERSION,
...
void
cofmsgtablestatstest::testReply(
		uint8_t version, uint8_t type, uint32_t xid, uint16_t stats_type, uint16_t stats_flags)
{
...
void
cofmsgtablestatstest::testRequestParser10()
{
...
void
cofmsgtablestatstest::testRequestParser12()
{
...
void
cofmsgtablestatstest::testRequestParser13()
{
...
void
cofmsgtablestatstest::testReplyParser10()
{
	uint8_t version = rofl::openflow10::OFP_VERSION;
...
void
cofmsgtablestatstest::testReplyParser12()
{
	uint8_t version = rofl::openflow12::OFP_VERSION;
...
void
cofmsgtablestatstest::testReplyParser13()
{
	uint8_t version = rofl::openflow13::OFP_VERSION;
	uint64_t lookup_count = 0x6162636465666768;
