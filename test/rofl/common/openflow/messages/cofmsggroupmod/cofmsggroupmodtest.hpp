...
class cofmsggroupmodtest : public CppUnit::TestFixture {
...
private:
  void testGroupMod(uint8_t version, uint8_t type, uint32_t xid);
  void testGroupModParser(uint8_t version, uint8_t type, uint32_t xid);
};
