...
void
cofmsggroupdescstatstest::setUp()
{}



void
cofmsggroupdescstatstest::tearDown()
{}



void
cofmsggroupdescstatstest::testRequest12()
{
	testRequest(
			rofl::openflow12::OFP_VERSION,
			rofl::openflow12::OFPT_STATS_REQUEST,
			0xa1a2a3a4,
			rofl::openflow12::OFPST_GROUP_DESC,
			0xb1b2);
}
...
void
cofmsggroupdescstatstest::testRequest13()
{
	testRequest(
			rofl::openflow13::OFP_VERSION,
			rofl::openflow13::OFPT_MULTIPART_REQUEST,
			0xa1a2a3a4,
			rofl::openflow13::OFPMP_GROUP_DESC,
			0xb1b2);
}
...
void
cofmsggroupdescstatstest::testRequest(
		uint8_t version, uint8_t type, uint32_t xid, uint16_t stats_type, uint16_t stats_flags)
{
	rofl::openflow::cofmsg_group_desc_stats_request msg1(version, xid, stats_flags);
...
void
cofmsggroupdescstatstest::testReply12()
{
	testReply(
			rofl::openflow12::OFP_VERSION,
...
void
cofmsggroupdescstatstest::testReply13()
{
	testReply(
			rofl::openflow13::OFP_VERSION,
...
void
cofmsggroupdescstatstest::testReply(
		uint8_t version, uint8_t type, uint32_t xid, uint16_t stats_type, uint16_t stats_flags)
{
...
void
cofmsggroupdescstatstest::testRequestParser12()
{
...
void
cofmsggroupdescstatstest::testRequestParser13()
{
...
void
cofmsggroupdescstatstest::testReplyParser12()
{
	uint8_t version = rofl::openflow12::OFP_VERSION;
...
void
cofmsggroupdescstatstest::testReplyParser13()
{
	uint8_t version = rofl::openflow13::OFP_VERSION;
