...
#include "cofmsggroupdescstatstest.hpp"

using namespace rofl::openflow;

CPPUNIT_TEST_SUITE_REGISTRATION(cofmsggroupdescstatstest);

void cofmsggroupdescstatstest::setUp() {}

void cofmsggroupdescstatstest::tearDown() {}

void cofmsggroupdescstatstest::testRequest12() {
  testRequest(rofl::openflow12::OFP_VERSION,
              rofl::openflow12::OFPT_STATS_REQUEST, 0xa1a2a3a4,
              rofl::openflow12::OFPST_GROUP_DESC, 0xb1b2);
}

void cofmsggroupdescstatstest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_MULTIPART_REQUEST, 0xa1a2a3a4,
              rofl::openflow13::OFPMP_GROUP_DESC, 0xb1b2);
}

void cofmsggroupdescstatstest::testRequest(uint8_t version, uint8_t type,
                                           uint32_t xid, uint16_t stats_type,
                                           uint16_t stats_flags) {
  rofl::openflow::cofmsg_group_desc_stats_request msg1(version, xid,
                                                       stats_flags);
  rofl::openflow::cofmsg_group_desc_stats_request msg2;
...
void cofmsggroupdescstatstest::testReply12() {
  testReply(rofl::openflow12::OFP_VERSION, rofl::openflow12::OFPT_STATS_REPLY,
            0xa1a2a3a4, rofl::openflow12::OFPST_GROUP_DESC, 0xb1b2);
}

void cofmsggroupdescstatstest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION,
            rofl::openflow13::OFPT_MULTIPART_REPLY, 0xa1a2a3a4,
            rofl::openflow13::OFPMP_GROUP_DESC, 0xb1b2);
}

void cofmsggroupdescstatstest::testReply(uint8_t version, uint8_t type,
                                         uint32_t xid, uint16_t stats_type,
                                         uint16_t stats_flags) {
  rofl::openflow::cofmsg_group_desc_stats_reply msg1(version, xid, stats_flags);
  rofl::openflow::cofmsg_group_desc_stats_reply msg2;
  rofl::cmemory mem(msg1.length());
  ...
  try {
    ...
    CPPUNIT_ASSERT(msg2.get_stats_type() == stats_type);
    CPPUNIT_ASSERT(msg2.get_stats_flags() == stats_flags);
    CPPUNIT_ASSERT(msg2.get_group_desc_stats_array().get_version() == version);
...
void cofmsggroupdescstatstest::testRequestParser12() {
  ...
  stats->type = htobe16(rofl::openflow12::OFPST_GROUP_DESC);
...
void cofmsggroupdescstatstest::testRequestParser13() {
  ...
  stats->header.xid = htobe32(0xa0a1a2a3);
  stats->header.length = htobe16(0);
  stats->type = htobe16(rofl::openflow13::OFPMP_GROUP_DESC);
  stats->flags = htobe16(0xb1b2);
...
void cofmsggroupdescstatstest::testReplyParser12() {
  uint8_t version = rofl::openflow12::OFP_VERSION;
  ...
  size_t memlen = msglen + groupdesc.length() + /*test overhead*/ 4;
...
void cofmsggroupdescstatstest::testReplyParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
