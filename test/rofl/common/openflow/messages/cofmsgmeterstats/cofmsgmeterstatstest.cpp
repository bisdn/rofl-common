...
void cofmsgmeterstatstest::setUp() {}

void cofmsgmeterstatstest::tearDown() {}

void cofmsgmeterstatstest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_MULTIPART_REQUEST, 0xa1a2a3a4,
              rofl::openflow13::OFPMP_METER, 0xb1b2);
}

void cofmsgmeterstatstest::testRequest(uint8_t version, uint8_t type,
...
void cofmsgmeterstatstest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION,
            rofl::openflow13::OFPT_MULTIPART_REPLY, 0xa1a2a3a4,
            rofl::openflow13::OFPMP_METER, 0xb1b2);
}

void cofmsgmeterstatstest::testReply(uint8_t version, uint8_t type,
                                     uint32_t xid, uint16_t stats_type,
                                     uint16_t stats_flags) {
...
void cofmsgmeterstatstest::testRequestParser13() {
  ...
  size_t msglen =
      sizeof(struct rofl::openflow13::ofp_multipart_request) + meter.length();
...
void cofmsgmeterstatstest::testReplyParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
