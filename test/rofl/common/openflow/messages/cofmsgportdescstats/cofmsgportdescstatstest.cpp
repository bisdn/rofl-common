...
void cofmsgportdescstatstest::setUp() {}

void cofmsgportdescstatstest::tearDown() {}

void cofmsgportdescstatstest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_MULTIPART_REQUEST, 0xa1a2a3a4,
              rofl::openflow13::OFPMP_PORT_DESC, 0xb1b2);
}

void cofmsgportdescstatstest::testRequest(uint8_t version, uint8_t type,
                                          uint32_t xid, uint16_t stats_type,
                                          uint16_t stats_flags) {
  rofl::openflow::cofmsg_port_desc_stats_request msg1(version, xid,
                                                      stats_flags);
...
void cofmsgportdescstatstest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION,
            rofl::openflow13::OFPT_MULTIPART_REPLY, 0xa1a2a3a4,
            rofl::openflow13::OFPMP_PORT_DESC, 0xb1b2);
}

void cofmsgportdescstatstest::testReply(uint8_t version, uint8_t type,
                                        uint32_t xid, uint16_t stats_type,
                                        uint16_t stats_flags) {
...
void cofmsgportdescstatstest::testRequestParser13() {
...
void cofmsgportdescstatstest::testReplyParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
