...
void cofmsgbarriertest::setUp() {}

void cofmsgbarriertest::tearDown() {}

void cofmsgbarriertest::testRequest10() {
  testRequest(rofl::openflow10::OFP_VERSION,
              rofl::openflow10::OFPT_BARRIER_REQUEST, 0xa1a2a3a4);
}

void cofmsgbarriertest::testRequest12() {
  testRequest(rofl::openflow12::OFP_VERSION,
              rofl::openflow12::OFPT_BARRIER_REQUEST, 0xa1a2a3a4);
}

void cofmsgbarriertest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_BARRIER_REQUEST, 0xa1a2a3a4);
}

void cofmsgbarriertest::testRequest(uint8_t version, uint8_t type,
                                    uint32_t xid) {
...
void cofmsgbarriertest::testReply10() {
  testReply(rofl::openflow10::OFP_VERSION, rofl::openflow10::OFPT_BARRIER_REPLY,
            0xa1a2a3a4);
}

void cofmsgbarriertest::testReply12() {
  testReply(rofl::openflow12::OFP_VERSION, rofl::openflow12::OFPT_BARRIER_REPLY,
            0xa1a2a3a4);
}

void cofmsgbarriertest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION, rofl::openflow13::OFPT_BARRIER_REPLY,
            0xa1a2a3a4);
}

void cofmsgbarriertest::testReply(uint8_t version, uint8_t type, uint32_t xid) {
...
void cofmsgbarriertest::testRequestParser10() {
  testRequestParser(rofl::openflow10::OFP_VERSION,
                    rofl::openflow10::OFPT_BARRIER_REQUEST, 0xa1a2a3a4);
}

void cofmsgbarriertest::testRequestParser12() {
  testRequestParser(rofl::openflow12::OFP_VERSION,
                    rofl::openflow12::OFPT_BARRIER_REQUEST, 0xa1a2a3a4);
}

void cofmsgbarriertest::testRequestParser13() {
  testRequestParser(rofl::openflow13::OFP_VERSION,
                    rofl::openflow13::OFPT_BARRIER_REQUEST, 0xa1a2a3a4);
}

void cofmsgbarriertest::testRequestParser(uint8_t version, uint8_t type,
                                          uint32_t xid) {
...
void cofmsgbarriertest::testReplyParser10() {
  testReplyParser(rofl::openflow10::OFP_VERSION,
                  rofl::openflow10::OFPT_BARRIER_REPLY, 0xa1a2a3a4);
}

void cofmsgbarriertest::testReplyParser12() {
  testReplyParser(rofl::openflow12::OFP_VERSION,
                  rofl::openflow12::OFPT_BARRIER_REPLY, 0xa1a2a3a4);
}

void cofmsgbarriertest::testReplyParser13() {
  testReplyParser(rofl::openflow13::OFP_VERSION,
                  rofl::openflow13::OFPT_BARRIER_REPLY, 0xa1a2a3a4);
}

void cofmsgbarriertest::testReplyParser(uint8_t version, uint8_t type,
                                        uint32_t xid) {
  size_t msglen = sizeof(struct rofl::openflow13::ofp_header);
  size_t memlen = 2 * msglen /*test overhead*/;
