/*
 * cofmsgbarriertest.hpp
 *
 *  Created on: Apr 26, 2015
 *      Author: andi
 */

#ifndef TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGBARRIER_TEST_HPP_
#define TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGBARRIER_TEST_HPP_
...
class cofmsgbarriertest : public CppUnit::TestFixture {
  CPPUNIT_TEST_SUITE(cofmsgbarriertest);
...
#endif /* TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGBARRIER_TEST_HPP_ */
