...
void cofmsgasyncconfigtest::setUp() {}

void cofmsgasyncconfigtest::tearDown() {}

void cofmsgasyncconfigtest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_GET_ASYNC_REQUEST, 0xa1a2a3a4);
}

void cofmsgasyncconfigtest::testRequest(uint8_t version, uint8_t type,
                                        uint32_t xid) {
...
void cofmsgasyncconfigtest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION,
            rofl::openflow13::OFPT_GET_ASYNC_REPLY, 0xa1a2a3a4);
}

void cofmsgasyncconfigtest::testReply(uint8_t version, uint8_t type,
                                      uint32_t xid) {
...
void cofmsgasyncconfigtest::testSet13() {
  testSet(rofl::openflow13::OFP_VERSION, rofl::openflow13::OFPT_SET_ASYNC,
          0xa1a2a3a4);
}

void cofmsgasyncconfigtest::testSet(uint8_t version, uint8_t type,
                                    uint32_t xid) {
...
void cofmsgasyncconfigtest::testRequestParser13() {
...
void cofmsgasyncconfigtest::testReplyParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
  ...
  size_t msglen =
      sizeof(struct rofl::openflow13::ofp_header) + async_config.length();
  size_t memlen = 2 * msglen /*test overhead*/;
...
void cofmsgasyncconfigtest::testSetParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
  uint32_t flow_removed_mask_master = 0xb1b2b3b4;
  uint32_t flow_removed_mask_slave = 0xc1c2c3c4;
  uint32_t packet_in_mask_master = 0xd1d2d3d4;
