...
void cofmsgechotest::setUp() {}

void cofmsgechotest::tearDown() {}

void cofmsgechotest::testRequest10() {
  testRequest(rofl::openflow10::OFP_VERSION,
              rofl::openflow10::OFPT_ECHO_REQUEST, 0xa1a2a3a4);
}

void cofmsgechotest::testRequest12() {
  testRequest(rofl::openflow12::OFP_VERSION,
              rofl::openflow12::OFPT_ECHO_REQUEST, 0xa1a2a3a4);
}

void cofmsgechotest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_ECHO_REQUEST, 0xa1a2a3a4);
}

void cofmsgechotest::testRequest(uint8_t version, uint8_t type, uint32_t xid) {
...
void cofmsgechotest::testReply10() {
  testReply(rofl::openflow10::OFP_VERSION, rofl::openflow10::OFPT_ECHO_REPLY,
            0xa1a2a3a4);
}

void cofmsgechotest::testReply12() {
  testReply(rofl::openflow12::OFP_VERSION, rofl::openflow12::OFPT_ECHO_REPLY,
            0xa1a2a3a4);
}

void cofmsgechotest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION, rofl::openflow13::OFPT_ECHO_REPLY,
            0xa1a2a3a4);
}

void cofmsgechotest::testReply(uint8_t version, uint8_t type, uint32_t xid) {
...
void cofmsgechotest::testRequestParser10() {
  testRequestParser(rofl::openflow10::OFP_VERSION,
                    rofl::openflow10::OFPT_ECHO_REQUEST, 0xa1a2a3a4);
}

void cofmsgechotest::testRequestParser12() {
  testRequestParser(rofl::openflow12::OFP_VERSION,
                    rofl::openflow12::OFPT_ECHO_REQUEST, 0xa1a2a3a4);
}

void cofmsgechotest::testRequestParser13() {
  testRequestParser(rofl::openflow13::OFP_VERSION,
                    rofl::openflow13::OFPT_ECHO_REQUEST, 0xa1a2a3a4);
}

void cofmsgechotest::testRequestParser(uint8_t version, uint8_t type,
                                       uint32_t xid) {
...
void cofmsgechotest::testReplyParser10() {
  testReplyParser(rofl::openflow10::OFP_VERSION,
                  rofl::openflow10::OFPT_ECHO_REPLY, 0xa1a2a3a4);
}

void cofmsgechotest::testReplyParser12() {
  testReplyParser(rofl::openflow12::OFP_VERSION,
                  rofl::openflow12::OFPT_ECHO_REPLY, 0xa1a2a3a4);
}

void cofmsgechotest::testReplyParser13() {
  testReplyParser(rofl::openflow13::OFP_VERSION,
                  rofl::openflow13::OFPT_ECHO_REPLY, 0xa1a2a3a4);
}

void cofmsgechotest::testReplyParser(uint8_t version, uint8_t type,
                                     uint32_t xid) {
  rofl::cmemory body(16);
