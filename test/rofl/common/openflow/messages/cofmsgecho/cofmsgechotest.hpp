...
#ifndef TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGECHO_TEST_HPP_
#define TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGECHO_TEST_HPP_
...
class cofmsgechotest : public CppUnit::TestFixture {
  CPPUNIT_TEST_SUITE(cofmsgechotest);
...
#endif /* TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGECHO_TEST_HPP_ */
