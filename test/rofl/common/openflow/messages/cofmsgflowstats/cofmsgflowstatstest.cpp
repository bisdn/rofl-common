...
void cofmsgflowstatstest::setUp() {}

void cofmsgflowstatstest::tearDown() {}

void cofmsgflowstatstest::testRequest10() {
  testRequest(rofl::openflow10::OFP_VERSION,
              rofl::openflow10::OFPT_STATS_REQUEST, 0xa1a2a3a4,
              rofl::openflow10::OFPST_FLOW, 0xb1b2);
}

void cofmsgflowstatstest::testRequest12() {
  testRequest(rofl::openflow12::OFP_VERSION,
              rofl::openflow12::OFPT_STATS_REQUEST, 0xa1a2a3a4,
              rofl::openflow12::OFPST_FLOW, 0xb1b2);
}

void cofmsgflowstatstest::testRequest13() {
  testRequest(rofl::openflow13::OFP_VERSION,
              rofl::openflow13::OFPT_MULTIPART_REQUEST, 0xa1a2a3a4,
              rofl::openflow13::OFPMP_FLOW, 0xb1b2);
}

void cofmsgflowstatstest::testRequest(uint8_t version, uint8_t type,
...
void cofmsgflowstatstest::testReply10() {
  testReply(rofl::openflow10::OFP_VERSION, rofl::openflow10::OFPT_STATS_REPLY,
            0xa1a2a3a4, rofl::openflow10::OFPST_FLOW, 0xb1b2);
}

void cofmsgflowstatstest::testReply12() {
  testReply(rofl::openflow12::OFP_VERSION, rofl::openflow12::OFPT_STATS_REPLY,
            0xa1a2a3a4, rofl::openflow12::OFPST_FLOW, 0xb1b2);
}

void cofmsgflowstatstest::testReply13() {
  testReply(rofl::openflow13::OFP_VERSION,
            rofl::openflow13::OFPT_MULTIPART_REPLY, 0xa1a2a3a4,
            rofl::openflow13::OFPMP_FLOW, 0xb1b2);
}

void cofmsgflowstatstest::testReply(uint8_t version, uint8_t type, uint32_t xid,
...
void cofmsgflowstatstest::testRequestParser10() {
  ...
  cofflow_stats_request flow(version, match, table_id, out_port);

  size_t msglen =
      sizeof(struct rofl::openflow10::ofp_stats_request) + flow.length();
...
void cofmsgflowstatstest::testRequestParser12() {
  ...
  size_t msglen =
      sizeof(struct rofl::openflow12::ofp_stats_request) + flow.length();
  size_t memlen = msglen + /*test overhead*/ 4;
...
void cofmsgflowstatstest::testRequestParser13() {
  ...
  size_t msglen =
      sizeof(struct rofl::openflow13::ofp_multipart_request) + flow.length();
  size_t memlen = msglen + /*test overhead*/ 4;
...
void cofmsgflowstatstest::testReplyParser10() {
  uint8_t version = rofl::openflow10::OFP_VERSION;
...
void cofmsgflowstatstest::testReplyParser12() {
  uint8_t version = rofl::openflow12::OFP_VERSION;
  uint64_t cookie = 0xa0a1a2a3a4a5a6a7;
  uint16_t idle_timeout = 0xb0b1;
  uint16_t hard_timeout = 0xc0c1;
...
void cofmsgflowstatstest::testReplyParser13() {
  uint8_t version = rofl::openflow13::OFP_VERSION;
  uint64_t cookie = 0xa0a1a2a3a4a5a6a7;
  uint16_t idle_timeout = 0xb0b1;
  uint16_t hard_timeout = 0xc0c1;
