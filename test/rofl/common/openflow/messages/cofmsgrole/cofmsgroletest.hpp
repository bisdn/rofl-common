...
#ifndef TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGROLE_TEST_HPP_
#define TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGROLE_TEST_HPP_
...
class cofmsgroletest : public CppUnit::TestFixture {
  CPPUNIT_TEST_SUITE(cofmsgroletest);
...
#endif /* TEST_SRC_ROFL_COMMON_OPENFLOW_MESSAGES_COFMSGROLE_TEST_HPP_ */
