...
void
cofmsghellotest::setUp()
{}



void
cofmsghellotest::tearDown()
{}



void
cofmsghellotest::testHello10()
{
	testHello(
			rofl::openflow10::OFP_VERSION,
			rofl::openflow10::OFPT_HELLO,
			0xa1a2a3a4);
}
...
void
cofmsghellotest::testHello12()
{
	testHello(
			rofl::openflow12::OFP_VERSION,
			rofl::openflow12::OFPT_HELLO,
			0xa1a2a3a4);
}
		...
		uint8_t version, uint8_t type, uint32_t xid)
{
	...
	try {
		...
		CPPUNIT_ASSERT(msg2.get_helloelems().get_hello_elem_versionbitmap().has_ofp_version(version));
...
void
cofmsghellotest::testHelloParser10()
{
	testHelloParser(
			rofl::openflow10::OFP_VERSION,
			rofl::openflow10::OFPT_HELLO,
...
void
cofmsghellotest::testHelloParser12()
{
	testHelloParser(
			rofl::openflow12::OFP_VERSION,
			rofl::openflow12::OFPT_HELLO,
...
void
cofmsghellotest::testHelloParser13()
{
	testHelloParser(
			rofl::openflow13::OFP_VERSION,
			rofl::openflow13::OFPT_HELLO,
...
void
cofmsghellotest::testHelloParser(
		uint8_t version, uint8_t type, uint32_t xid)
{
	rofl::openflow::cofhelloelems helloIEs;
	helloIEs.set_hello_elem_versionbitmap().add_ofp_version(version);

	size_t msglen = sizeof(struct rofl::openflow13::ofp_group_mod) + helloIEs.length();
