...
void cofmeterbandstats_test::setUp() {}

void cofmeterbandstats_test::tearDown() {}

void cofmeterbandstats_test::testDefaultConstructor() {
...
void cofmeterbandstats_test::testCopyConstructor() {
...
void cofmeterbandstats_test::testPackUnpack() {
  uint8_t of_version = rofl::openflow13::OFP_VERSION;
  uint64_t packet_band_count = 0xa1a2a3a4a5a6a7a8;
  uint64_t byte_band_count = 0xb1b2b3b4b5b6b7b8;
