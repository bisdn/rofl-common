...
void coftablesTest::setUp() {}

void coftablesTest::tearDown() {}

void coftablesTest::testDefaultConstructor() {
  rofl::openflow::coftables tables;
  CPPUNIT_ASSERT(rofl::openflow::OFP_VERSION_UNKNOWN == tables.get_version());
}

void coftablesTest::testCopyConstructor() {
...
void coftablesTest::testPackUnpack() {
  rofl::openflow::coftables tables(rofl::openflow13::OFP_VERSION);
  ...
  tables.set_table(0).set_properties().set_tfp_instructions().add_instruction(
      rofl::openflow13::OFPIT_WRITE_ACTIONS);
  tables.set_table(0).set_properties().set_tfp_instructions().add_instruction(
      rofl::openflow13::OFPIT_APPLY_ACTIONS);
  tables.set_table(0).set_properties().set_tfp_instructions().add_instruction(
      rofl::openflow13::OFPIT_CLEAR_ACTIONS);
  tables.set_table(0).set_properties().set_tfp_instructions().add_instruction(
      rofl::openflow13::OFPIT_WRITE_METADATA);
  tables.set_table(0).set_properties().set_tfp_instructions().add_instruction(
      rofl::openflow13::OFPIT_GOTO_TABLE);
  tables.set_table(0).set_properties().set_tfp_instructions().add_instruction(
      rofl::openflow13::OFPIT_METER);
  ...
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_IN_PORT);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_IN_PHY_PORT);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ETH_DST);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ETH_DST_MASK);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ETH_SRC);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ETH_SRC_MASK);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ETH_TYPE);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_VLAN_VID);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_VLAN_VID_MASK);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_VLAN_PCP);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ARP_OP);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ARP_SHA);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ARP_SHA_MASK);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ARP_THA);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ARP_THA_MASK);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ARP_SPA);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ARP_SPA_MASK);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ARP_TPA);
  tables.set_table(0).set_properties().set_tfp_match().add_oxm(
      rofl::openflow::OXM_TLV_BASIC_ARP_TPA_MASK);
  tables.set_table(0).set_properties().set_tfp_apply_actions().add_action(
      rofl::openflow::OFPAT_OUTPUT);
  tables.set_table(0).set_properties().set_tfp_apply_actions().add_action(
      rofl::openflow::OFPAT_COPY_TTL_IN);
  tables.set_table(0).set_properties().set_tfp_apply_actions().add_action(
      rofl::openflow::OFPAT_COPY_TTL_OUT);
  ...
  tables.set_table(1).set_properties().set_tfp_instructions().add_instruction(
      rofl::openflow13::OFPIT_WRITE_ACTIONS);
  tables.set_table(1).set_properties().set_tfp_instructions().add_instruction(
      rofl::openflow13::OFPIT_APPLY_ACTIONS);
  tables.set_table(1).set_properties().set_tfp_instructions().add_instruction(
  ...
  tables.set_table(5).set_properties().set_tfp_instructions().add_instruction(
      rofl::openflow13::OFPIT_WRITE_ACTIONS);
  tables.set_table(5).set_properties().set_tfp_instructions().add_instruction(
      rofl::openflow13::OFPIT_APPLY_ACTIONS);
  tables.set_table(5).set_properties().set_tfp_instructions().add_instruction(
...
void coftablesTest::testAddDropSetGetHas() {
  rofl::openflow::coftables tables(rofl::openflow13::OFP_VERSION);
...
void coftablesTest::testMappingTableStatsArray() {
  ...
  uint32_t instructions =
      (((uint32_t)1 << OFPIT_MAX) - 1) - (((uint32_t)1 << OFPIT_MIN) - 1);

  uint32_t apply_actions = (1 << rofl::openflow::OFPAT_OUTPUT) |
  ...
  match = (1 << rofl::openflow::OFPXMT_OFB_ETH_DST) |
          (1 << rofl::openflow::OFPXMT_OFB_ETH_SRC) |
          (1 << rofl::openflow::OFPXMT_OFB_ETH_TYPE);
  wildcards = (1 << rofl::openflow::OFPXMT_OFB_ETH_DST) |
              (1 << rofl::openflow::OFPXMT_OFB_ETH_SRC);
  instructions = (1 << rofl::openflow::OFPIT_APPLY_ACTIONS) |
                 (1 << rofl::openflow::OFPIT_GOTO_TABLE);
  apply_actions = (1 << rofl::openflow::OFPAT_OUTPUT) |
                  (1 << rofl::openflow::OFPAT_SET_FIELD);
  write_actions = 0;
  apply_setfields = (1 << rofl::openflow::OFPXMT_OFB_ETH_DST) |
                    (1 << rofl::openflow::OFPXMT_OFB_ETH_SRC);
  write_setfields = 0;
