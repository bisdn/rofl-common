...
void cofaction_test::setUp() {}

void cofaction_test::tearDown() {}

void cofaction_test::testAction() {
...
void cofaction_test::testActionOutput() {
  ...
  CPPUNIT_ASSERT(action.get_length() ==
                 sizeof(struct rofl::openflow13::ofp_action_output));
  CPPUNIT_ASSERT(action.length() ==
                 sizeof(struct rofl::openflow13::ofp_action_output));
  ...
  CPPUNIT_ASSERT(clone.get_length() ==
                 sizeof(struct rofl::openflow13::ofp_action_output));
...
void cofaction_test::testActionOutput10() {
  ...
  CPPUNIT_ASSERT(action.get_type() == rofl::openflow::OFPAT_OUTPUT);
  CPPUNIT_ASSERT(action.get_length() ==
                 sizeof(struct rofl::openflow10::ofp_action_output));
  CPPUNIT_ASSERT(action.length() ==
                 sizeof(struct rofl::openflow10::ofp_action_output));
  CPPUNIT_ASSERT(action.get_port_no() == port_no);
  CPPUNIT_ASSERT(action.get_max_len() == max_len);
...
void cofaction_test::testActionSetVlanVid() {
  uint16_t vid = 0xa1a2;
  ...
  CPPUNIT_ASSERT(action.get_length() ==
                 sizeof(struct rofl::openflow10::ofp_action_vlan_vid));
  CPPUNIT_ASSERT(action.length() ==
                 sizeof(struct rofl::openflow10::ofp_action_vlan_vid));
...
void cofaction_test::testActionSetVlanPcp() {
  uint8_t pcp = 0xa1;
...
void cofaction_test::testActionStripVlan() {
  ...
  CPPUNIT_ASSERT(action.get_length() ==
                 sizeof(struct rofl::openflow10::ofp_action_header));
  CPPUNIT_ASSERT(action.length() ==
                 sizeof(struct rofl::openflow10::ofp_action_header));
...
void cofaction_test::testActionSetDlSrc() {
  ...
  CPPUNIT_ASSERT(action.get_length() ==
                 sizeof(struct rofl::openflow10::ofp_action_dl_addr));
  CPPUNIT_ASSERT(action.length() ==
                 sizeof(struct rofl::openflow10::ofp_action_dl_addr));
...
void cofaction_test::testActionSetDlDst() {
  rofl::cmacaddr addr("a1:a2:a3:a4:a5:a6");
...
void cofaction_test::testActionSetNwSrc() {
  ...
  CPPUNIT_ASSERT(action.get_length() ==
                 sizeof(struct rofl::openflow10::ofp_action_nw_addr));
  CPPUNIT_ASSERT(action.length() ==
                 sizeof(struct rofl::openflow10::ofp_action_nw_addr));
...
void cofaction_test::testActionSetNwDst() {
  rofl::caddress_in4 addr("161.162.163.164");
...
void cofaction_test::testActionSetNwTos() {
  uint8_t nw_tos = 0xa1;
...
void cofaction_test::testActionSetTpSrc() {
  ...
  CPPUNIT_ASSERT(action.get_length() ==
                 sizeof(struct rofl::openflow10::ofp_action_tp_port));
  CPPUNIT_ASSERT(action.length() ==
                 sizeof(struct rofl::openflow10::ofp_action_tp_port));
...
void cofaction_test::testActionSetTpDst() {
...
void cofaction_test::testActionEnqueue() {
  uint16_t port_no = 0xa1a2;
  ...
  CPPUNIT_ASSERT(action.get_length() ==
                 sizeof(struct rofl::openflow10::ofp_action_enqueue));
  CPPUNIT_ASSERT(action.length() ==
                 sizeof(struct rofl::openflow10::ofp_action_enqueue));
  CPPUNIT_ASSERT(action.get_port_no() == port_no);
...
void cofaction_test::testActionVendor() {
...
void cofaction_test::testActionCopyTtlOut() {
...
void cofaction_test::testActionCopyTtlIn() {
...
void cofaction_test::testActionSetMplsTtl() {
  ...
  CPPUNIT_ASSERT(action.get_length() ==
                 sizeof(struct rofl::openflow13::ofp_action_mpls_ttl));
  CPPUNIT_ASSERT(action.length() ==
                 sizeof(struct rofl::openflow13::ofp_action_mpls_ttl));
...
void cofaction_test::testActionDecMplsTtl() {
...
void cofaction_test::testActionPushVlan() {
  ...
  CPPUNIT_ASSERT(action.get_length() ==
                 sizeof(struct rofl::openflow13::ofp_action_push));
  CPPUNIT_ASSERT(action.length() ==
                 sizeof(struct rofl::openflow13::ofp_action_push));
...
void cofaction_test::testActionPopVlan() {
...
void cofaction_test::testActionPushMpls() {
  uint16_t eth_type = 0xa1a2;
...
void cofaction_test::testActionPopMpls() {
  uint16_t eth_type = 0xa1a2;
  ...
  CPPUNIT_ASSERT(action.get_length() ==
                 sizeof(struct rofl::openflow13::ofp_action_pop_mpls));
  CPPUNIT_ASSERT(action.length() ==
                 sizeof(struct rofl::openflow13::ofp_action_pop_mpls));
  CPPUNIT_ASSERT(action.get_eth_type() == eth_type);
...
void cofaction_test::testActionGroup() {
...
void cofaction_test::testActionSetNwTtl() {
  uint8_t nw_ttl = 0xa1;
  ...
  CPPUNIT_ASSERT(action.get_length() ==
                 sizeof(struct rofl::openflow13::ofp_action_nw_ttl));
  CPPUNIT_ASSERT(action.length() ==
                 sizeof(struct rofl::openflow13::ofp_action_nw_ttl));
...
void cofaction_test::testActionDecNwTtl() {
...
void cofaction_test::testActionSetQueue() {
  ...
  CPPUNIT_ASSERT(action.get_length() ==
                 sizeof(struct rofl::openflow13::ofp_action_set_queue));
  CPPUNIT_ASSERT(action.length() ==
                 sizeof(struct rofl::openflow13::ofp_action_set_queue));
  CPPUNIT_ASSERT(action.get_queue_id() == queue_id);
...
void cofaction_test::testActionPushPbb() {
  uint16_t eth_type = 0xa1a2;
...
void cofaction_test::testActionPopPbb() {
...
void cofaction_test::testActionCopyField1() {
  ...
  rofl::openflow::experimental::ext320::cofaction_body_copy_field copy_field(
      n_bits, src_offset, dst_offset, src_oxm_id, src_oxm_exp_id, dst_oxm_id,
      dst_oxm_exp_id);
  ...
  CPPUNIT_ASSERT(copied.get_exp_id() ==
                 rofl::openflow::experimental::ext320::EXT320_EXP_ID);
  rofl::openflow::experimental::ext320::cofaction_body_copy_field
      copied_copy_field(copied.get_exp_body());

  std::cerr << ">>> copied copy_field body: <<<" << std::endl
            << copied_copy_field;
