...
void coftablefeaturepropsTest::setUp() {}

void coftablefeaturepropsTest::tearDown() {}

void coftablefeaturepropsTest::testDefaultConstructor() {
...
void coftablefeaturepropsTest::testCopyConstructor() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);

  props.add_tfp_instructions().add_instruction(
      rofl::openflow13::OFPIT_APPLY_ACTIONS);
  props.set_tfp_instructions().add_instruction(
      rofl::openflow13::OFPIT_WRITE_ACTIONS);
  props.set_tfp_instructions().add_instruction(
      rofl::openflow13::OFPIT_GOTO_TABLE);
  props.add_tfp_instructions_miss().add_instruction(
      rofl::openflow13::OFPIT_GOTO_TABLE);
  props.set_tfp_instructions_miss().add_instruction(
      rofl::openflow13::OFPIT_APPLY_ACTIONS);
  ...
  CPPUNIT_ASSERT(clone.get_tfp_instructions().get_instruction_ids().size() ==
                 3);
  CPPUNIT_ASSERT(
      clone.get_tfp_instructions_miss().get_instruction_ids().size() == 2);
}

void coftablefeaturepropsTest::testAddDropSetGetHasInstructions() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
...
void coftablefeaturepropsTest::testAddDropSetGetHasInstructionsMiss() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
...
void coftablefeaturepropsTest::testAddDropSetGetHasNextTables() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
...
void coftablefeaturepropsTest::testAddDropSetGetHasNextTablesMiss() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
...
void coftablefeaturepropsTest::testAddDropSetGetHasWriteActions() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
...
void coftablefeaturepropsTest::testAddDropSetGetHasWriteActionsMiss() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
...
void coftablefeaturepropsTest::testAddDropSetGetHasApplyActions() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
...
void coftablefeaturepropsTest::testAddDropSetGetHasApplyActionsMiss() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
...
void coftablefeaturepropsTest::testAddDropSetGetHasMatch() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
...
void coftablefeaturepropsTest::testAddDropSetGetHasWildcards() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
...
void coftablefeaturepropsTest::testAddDropSetGetHasWriteSetField() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
...
void coftablefeaturepropsTest::testAddDropSetGetHasWriteSetFieldMiss() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
...
void coftablefeaturepropsTest::testAddDropSetGetHasApplySetField() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
...
void coftablefeaturepropsTest::testAddDropSetGetHasApplySetFieldMiss() {
  rofl::openflow::coftable_feature_props props(rofl::openflow13::OFP_VERSION);
