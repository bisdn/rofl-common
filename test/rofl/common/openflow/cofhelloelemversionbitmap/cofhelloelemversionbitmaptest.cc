...
void cofhelloelemversionbitmapTest::setUp() {
  ...
  hello->length =
      htobe16(12); // bitmap[0] and bitmap[1], following 4 bytes are padding
  uint32_t bitmap0 = 0;
...
void cofhelloelemversionbitmapTest::tearDown() {
  delete mem;
  delete elem;
}

void cofhelloelemversionbitmapTest::testPack() {
...
void cofhelloelemversionbitmapTest::testUnPack() {
