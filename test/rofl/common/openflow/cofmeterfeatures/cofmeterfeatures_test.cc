...
void cofmeterfeatures_test::setUp() {}

void cofmeterfeatures_test::tearDown() {}

void cofmeterfeatures_test::testDefaultConstructor() {
...
void cofmeterfeatures_test::testCopyConstructor() {
...
void cofmeterfeatures_test::testPackUnpack() {
  uint32_t max_meter = 0xa1a2a3a4;
  uint32_t band_types = 0xb1b2b3b4;
  uint32_t capabilities = 0xc1c2c3c4;
  uint8_t max_bands = 0xd1;
