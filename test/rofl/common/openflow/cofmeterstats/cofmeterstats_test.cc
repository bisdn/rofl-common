...
void cofmeterstats_test::setUp() {}

void cofmeterstats_test::tearDown() {}

void cofmeterstats_test::testDefaultConstructor() {
...
void cofmeterstats_test::testCopyConstructor() {
...
void cofmeterstats_test::testPackUnpack() {
  uint32_t meter_id = 0xa1a2a3a4;
  uint32_t flow_count = 0xb1b2b3b4;
  uint64_t packet_in_count = 0xc1c2c3c4c5c6c7c8;
  uint64_t byte_in_count = 0xd1d2d3d4d5d6d7d8;
