...
void cofqueuestatsarray_test::setUp() {}

void cofqueuestatsarray_test::tearDown() {}

void cofqueuestatsarray_test::testDefaultConstructor() {
  rofl::openflow::cofqueuestatsarray array;
  CPPUNIT_ASSERT(rofl::openflow::OFP_VERSION_UNKNOWN == array.get_version());
}

void cofqueuestatsarray_test::testCopyConstructor() {
...
void cofqueuestatsarray_test::testOperatorPlus() {
  std::vector<rofl::openflow::cofqueuestatsarray> array;
  array.push_back(
      rofl::openflow::cofqueuestatsarray(rofl::openflow13::OFP_VERSION));
  array.push_back(
      rofl::openflow::cofqueuestatsarray(rofl::openflow13::OFP_VERSION));
  ...
  std::cerr << "merge.set_queue_stats(0, 0) == array[0].get_queue_stats(0, 0): "
            << (merge.set_queue_stats(0, 0) == array[0].get_queue_stats(0, 0))
            << std::endl;
  std::cerr << "merge.set_queue_stats(0, 1) == array[0].get_queue_stats(0, 1): "
            << (merge.set_queue_stats(0, 1) == array[0].get_queue_stats(0, 1))
            << std::endl;
  std::cerr << "merge.set_queue_stats(1, 0) == array[0].get_queue_stats(1, 0): "
            << (merge.set_queue_stats(1, 0) == array[0].get_queue_stats(1, 0))
            << std::endl;
  std::cerr << "merge.set_queue_stats(4, 0) == array[1].get_queue_stats(4, 0): "
            << (merge.set_queue_stats(4, 0) == array[1].get_queue_stats(4, 0))
            << std::endl;
  std::cerr << "merge.set_queue_stats(5, 0) == array[1].get_queue_stats(5, 0): "
            << (merge.set_queue_stats(5, 0) == array[1].get_queue_stats(5, 0))
            << std::endl;
  std::cerr << "merge.set_queue_stats(5, 1) == array[1].get_queue_stats(5, 1): "
            << (merge.set_queue_stats(5, 1) == array[1].get_queue_stats(5, 1))
            << std::endl;
#endif
...
void cofqueuestatsarray_test::testPackUnpack() {
  /*
   * unpack
   */
  rofl::cmemory mem(sizeof(struct rofl::openflow13::ofp_queue_stats));
  struct rofl::openflow13::ofp_queue_stats *queue =
      (struct rofl::openflow13::ofp_queue_stats *)mem.somem();
  ...
  CPPUNIT_ASSERT(array.get_queue_stats(8, 1).get_tx_packets() ==
                 0x1112131415161718);
  CPPUNIT_ASSERT(array.get_queue_stats(8, 1).get_tx_bytes() ==
                 0x2122232425262728);
  CPPUNIT_ASSERT(array.get_queue_stats(8, 1).get_tx_errors() ==
                 0x3132333435363738);
...
void cofqueuestatsarray_test::testAddDropSetGetHas() {
  rofl::openflow::cofqueuestatsarray array(rofl::openflow13::OFP_VERSION);
