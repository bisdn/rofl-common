...
void cofmeterconfig_test::setUp() {}

void cofmeterconfig_test::tearDown() {}

void cofmeterconfig_test::testDefaultConstructor() {
...
void cofmeterconfig_test::testCopyConstructor() {
...
void cofmeterconfig_test::testPackUnpack() {
  uint16_t flags = 0xb1b2;
  uint32_t meter_id = 0xa1a2a3a4;
