...
void cofflowstatsarray_test::setUp() {}

void cofflowstatsarray_test::tearDown() {}

void cofflowstatsarray_test::testDefaultConstructor() {
  rofl::openflow::cofflowstatsarray array;
  CPPUNIT_ASSERT(rofl::openflow::OFP_VERSION_UNKNOWN == array.get_version());
}

void cofflowstatsarray_test::testCopyConstructor() {
...
void cofflowstatsarray_test::testOperatorPlus() {
  rofl::cindex index(0);

  std::vector<rofl::openflow::cofflowstatsarray> array;
  array.push_back(
      rofl::openflow::cofflowstatsarray(rofl::openflow13::OFP_VERSION));
  array.push_back(
      rofl::openflow::cofflowstatsarray(rofl::openflow13::OFP_VERSION));
  ...
  array[0].set_flow_stats(0).set_match().set_eth_dst(
      rofl::cmacaddr("11:22:33:44:55:66"));
  array[0].set_flow_stats(0).set_match().set_eth_src(
  ...
  array[0].set_flow_stats(1).set_match().set_eth_dst(
  ...
  array[1].set_flow_stats(0).set_match().set_eth_dst(
      rofl::cmacaddr("11:22:33:44:55:66"));
  array[1].set_flow_stats(0).set_match().set_eth_src(
      rofl::cmacaddr("22:22:22:22:22:22"));
  ...
  std::cerr << "merge.set_flow_stats(0) == array[0].get_flow_stats(0): "
            << (merge.set_flow_stats(0) == array[0].get_flow_stats(0))
            << std::endl;
  std::cerr << "merge.set_flow_stats(1) == array[0].get_flow_stats(1): "
            << (merge.set_flow_stats(1) == array[0].get_flow_stats(1))
            << std::endl;
  std::cerr << "merge.set_flow_stats(2) == array[1].get_flow_stats(0): "
            << (merge.set_flow_stats(2) == array[1].get_flow_stats(0))
            << std::endl;
  //#endif
...
void cofflowstatsarray_test::testPackUnpack() {
  rofl::cindex index(0);
...
void cofflowstatsarray_test::testAddDropSetGetHas() {
  rofl::openflow::cofflowstatsarray array(rofl::openflow13::OFP_VERSION);
