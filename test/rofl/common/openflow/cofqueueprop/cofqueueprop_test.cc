...
void cofqueueprop_test::setUp() {}

void cofqueueprop_test::tearDown() {}

void cofqueueprop_test::testQueueProp() {
  rofl::openflow::cofqueue_prop prop;
  CPPUNIT_ASSERT(rofl::openflow::OFP_VERSION_UNKNOWN == prop.get_version());
}

void cofqueueprop_test::testQueuePropMinRate() {
  ...
  CPPUNIT_ASSERT(prop.get_length() ==
                 sizeof(struct rofl::openflow13::ofp_queue_prop_min_rate));
...
void cofqueueprop_test::testQueuePropMaxRate() {
  ...
  CPPUNIT_ASSERT(prop.get_length() ==
                 sizeof(struct rofl::openflow13::ofp_queue_prop_max_rate));
...
void cofqueueprop_test::testQueuePropExperimenter() {
  ...
  rofl::openflow::cofqueue_prop_experimenter clone(
