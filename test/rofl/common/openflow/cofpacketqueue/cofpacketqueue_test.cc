...
void cofpacketqueue_test::setUp() {}

void cofpacketqueue_test::tearDown() {}

void cofpacketqueue_test::testPacketQueue() {
  ...
  CPPUNIT_ASSERT(
      clone.get_queue_props().get_queue_prop_min_rate().get_min_rate() ==
      queue.get_queue_props().get_queue_prop_min_rate().get_min_rate());
  CPPUNIT_ASSERT(
      clone.get_queue_props().get_queue_prop_max_rate().get_max_rate() ==
      queue.get_queue_props().get_queue_prop_max_rate().get_max_rate());
}
