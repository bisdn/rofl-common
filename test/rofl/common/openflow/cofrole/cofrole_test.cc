...
void cofrole_test::setUp() {}

void cofrole_test::tearDown() {}

void cofrole_test::testDefaultConstructor() {
  rofl::openflow::cofrole role;
  CPPUNIT_ASSERT(rofl::openflow::OFP_VERSION_UNKNOWN == role.get_version());
}

void cofrole_test::testCopyConstructor() {
...
void cofrole_test::testPackUnpack() {
  /*
   * pack
   */
  ...
  struct rofl::openflow::cofrole::role_t *r =
      (struct rofl::openflow::cofrole::role_t *)mrole.somem();
