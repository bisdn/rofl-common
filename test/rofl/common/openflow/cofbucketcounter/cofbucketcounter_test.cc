...
void cofbucketcounter_test::setUp() {}

void cofbucketcounter_test::tearDown() {}

void cofbucketcounter_test::testDefaultConstructor() {
  rofl::openflow::cofbucket_counter bc;
  CPPUNIT_ASSERT(rofl::openflow::OFP_VERSION_UNKNOWN == bc.get_version());
}

void cofbucketcounter_test::testCopyConstructor() {
...
void cofbucketcounter_test::testPackUnpack() {
  rofl::openflow::cofbucket_counter bc(rofl::openflow13::OFP_VERSION);
