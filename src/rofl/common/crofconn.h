...
class crofconn : public cthread_env, public crofsock_env {
  ...
  enum crofconn_state_t {
    ...
    STATE_CONNECT_REFUSED = 2,
    STATE_CONNECT_FAILED = 3,
    STATE_ACCEPT_PENDING = 4,
    STATE_ACCEPT_REFUSED = 5,
    STATE_ACCEPT_FAILED = 6,
    STATE_NEGOTIATING = 7,
    STATE_NEGOTIATING2 = 8,
    STATE_ESTABLISHED = 9,
  };
