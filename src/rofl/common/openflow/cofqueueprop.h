...
public:
  eQueuePropBase(const std::string &__arg = std::string(""))
      : exception(__arg) {
...
public:
  eQueuePropNotFound(const std::string &__arg = std::string(""))
...
public:
   ...
   *
   */
  cofqueue_prop(uint8_t of_version = openflow::OFP_VERSION_UNKNOWN,
                uint16_t property = 0)
      : ofp_version(of_version), property(property),
        len(sizeof(struct rofl::openflow12::ofp_queue_prop_header)){};

  /**
   *
   */
  virtual ~cofqueue_prop(){};

  /**
   *
   */
  cofqueue_prop(const cofqueue_prop &prop) { *this = prop; };

  /**
   *
   */
  cofqueue_prop &operator=(const cofqueue_prop &qp) {
    if (this == &qp)
      return *this;
...
public:
   ...
   *
   */
  uint16_t get_property() const { return property; };

  /**
   *
   */
  void set_property(uint16_t property) { this->property = property; };
...
public:
   ...
   *
   */
  friend std::ostream &operator<<(std::ostream &os, cofqueue_prop const &prop) {
    os << "<cofqueue_prop version: " << (int)prop.get_version() << std::hex
       << " property: 0x" << (int)prop.get_property() << std::dec
       << " length: " << (int)prop.get_length() << ">" << std::endl;
    return os;
  };
...
public:
   ...
   *
   */
  virtual ~cofqueue_prop_min_rate(){};
   ...
   *
   */
  cofqueue_prop_min_rate &operator=(const cofqueue_prop_min_rate &prop) {
    if (this == &prop)
      return *this;
...
public:
   ...
   *
   */
  uint16_t get_min_rate() const { return min_rate; };

  /**
   *
   */
  void set_min_rate(uint16_t min_rate) { this->min_rate = min_rate; };

public:
  friend std::ostream &operator<<(std::ostream &os,
                                  const cofqueue_prop_min_rate &prop) {
    os << "<cofqueue_prop_min_rate version: "
       << (unsigned int)prop.get_version() << " >" << std::endl;
    { os << dynamic_cast<const cofqueue_prop &>(prop); }
    os << "<min-rate: 0x" << std::hex << (unsigned int)prop.get_min_rate()
       << std::dec << " >" << std::endl;
    return os;
  };
...
public:
   ...
   *
   */
  virtual ~cofqueue_prop_max_rate(){};
   ...
   *
   */
  cofqueue_prop_max_rate &operator=(const cofqueue_prop_max_rate &prop) {
    if (this == &prop)
      return *this;
    cofqueue_prop::operator=(prop);
...
public:
   ...
   *
   */
  uint16_t get_max_rate() const { return max_rate; };

  /**
   *
   */
  void set_max_rate(uint16_t max_rate) { this->max_rate = max_rate; };

public:
  friend std::ostream &operator<<(std::ostream &os,
                                  const cofqueue_prop_max_rate &prop) {
    os << "<cofqueue_prop_max_rate version: "
       << (unsigned int)prop.get_version() << " >" << std::endl;
    { os << dynamic_cast<const cofqueue_prop &>(prop); }
    os << "<max-rate: 0x" << std::hex << (unsigned int)prop.get_max_rate()
       << std::dec << " >" << std::endl;
    return os;
  };
...
public:
   ...
   *
   */
  virtual ~cofqueue_prop_experimenter(){};
   ...
   */
  cofqueue_prop_experimenter &
  operator=(const cofqueue_prop_experimenter &prop) {
    if (this == &prop)
      return *this;
    cofqueue_prop::operator=(prop);
    exp_id = prop.exp_id;
...
public:
  friend std::ostream &operator<<(std::ostream &os,
    ...
    os << "<cofqueue_prop_experimenter version: "
       << (unsigned int)prop.get_version() << " >" << std::endl;
    { os << dynamic_cast<const cofqueue_prop &>(prop); }
