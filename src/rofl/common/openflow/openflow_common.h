...
#define OXM_ROFL_OFX_TYPE(x)                                                   \
  (((uint64_t)ROFL_EXP_ID << 32) | (OXM_ROFL_TYPE(x)))
#define OXM_EXPR_OFX_TYPE(w, x) (((uint64_t)w << 32) | (OXM_ROFL_TYPE(x)))

/* OXM Flow match field types for OpenFlow basic class. */
enum oxm_tlv_match_fields {
  OXM_TLV_BASIC_IN_PORT =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IN_PORT << 9) | 4,
  /* Switch input port. */ // required
  OXM_TLV_BASIC_IN_PHY_PORT =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IN_PHY_PORT << 9) |
      4, /* Switch physical input port. */
  OXM_TLV_BASIC_METADATA = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                           (OFPXMT_OFB_METADATA << 9) |
                           8, /* Metadata passed between tables. */
  OXM_TLV_BASIC_METADATA_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                                (OFPXMT_OFB_METADATA << 9) | 16 | HAS_MASK_FLAG,
  OXM_TLV_BASIC_ETH_DST =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ETH_DST << 9) | 6,
  /* Ethernet destination address. */ // required
  OXM_TLV_BASIC_ETH_DST_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                               (OFPXMT_OFB_ETH_DST << 9) | 12 | HAS_MASK_FLAG,
  OXM_TLV_BASIC_ETH_SRC =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ETH_SRC << 9) | 6,
  /* Ethernet source address. */ // required
  OXM_TLV_BASIC_ETH_SRC_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                               (OFPXMT_OFB_ETH_SRC << 9) | 12 | HAS_MASK_FLAG,
  OXM_TLV_BASIC_ETH_TYPE =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_ETH_TYPE << 9) | 2,
  /* Ethernet frame type. */ // required
  OXM_TLV_BASIC_VLAN_VID = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                           (OFPXMT_OFB_VLAN_VID << 9) | 2, /* VLAN id. */
  OXM_TLV_BASIC_VLAN_VID_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                                (OFPXMT_OFB_VLAN_VID << 9) | 4 | HAS_MASK_FLAG,
  OXM_TLV_BASIC_VLAN_PCP = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                           (OFPXMT_OFB_VLAN_PCP << 9) | 1, /* VLAN priority. */
  OXM_TLV_BASIC_IP_DSCP = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                          (OFPXMT_OFB_IP_DSCP << 9) |
                          1, /* IP DSCP (6 bits in ToS field). */
  OXM_TLV_BASIC_IP_ECN = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                         (OFPXMT_OFB_IP_ECN << 9) |
                         1, /* IP ECN (2 bits in ToS field). */
  OXM_TLV_BASIC_IP_PROTO =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IP_PROTO << 9) | 1,
  /* IP protocol. */ // required
  OXM_TLV_BASIC_IPV4_SRC =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IPV4_SRC << 9) | 4,
  /* IPv4 source address. */ // required
  OXM_TLV_BASIC_IPV4_SRC_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                                (OFPXMT_OFB_IPV4_SRC << 9) | 8 | HAS_MASK_FLAG,
  OXM_TLV_BASIC_IPV4_DST =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IPV4_DST << 9) | 4,
  /* IPv4 destination address. */ // required
  OXM_TLV_BASIC_IPV4_DST_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                                (OFPXMT_OFB_IPV4_DST << 9) | 8 | HAS_MASK_FLAG,
  OXM_TLV_BASIC_TCP_SRC =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_TCP_SRC << 9) | 2,
  /* TCP source port. */ // required
  OXM_TLV_BASIC_TCP_DST =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_TCP_DST << 9) | 2,
  /* TCP destination port. */ // required
  OXM_TLV_BASIC_UDP_SRC =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_UDP_SRC << 9) | 2,
  /* UDP source port. */ // required
  OXM_TLV_BASIC_UDP_DST =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_UDP_DST << 9) | 2,
  /* UDP destination port. */ // required
  OXM_TLV_BASIC_SCTP_SRC =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_SCTP_SRC << 9) |
      2, /* SCTP source port. */
  OXM_TLV_BASIC_SCTP_DST = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                           (OFPXMT_OFB_SCTP_DST << 9) |
                           2, /* SCTP destination port. */
  OXM_TLV_BASIC_ICMPV4_TYPE = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                              (OFPXMT_OFB_ICMPV4_TYPE << 9) |
                              1, /* ICMP type. */
  OXM_TLV_BASIC_ICMPV4_CODE = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                              (OFPXMT_OFB_ICMPV4_CODE << 9) |
                              1, /* ICMP code. */
  OXM_TLV_BASIC_ARP_OP = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                         (OFPXMT_OFB_ARP_OP << 9) | 2, /* ARP opcode. */
  OXM_TLV_BASIC_ARP_SPA = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                          (OFPXMT_OFB_ARP_SPA << 9) |
                          4, /* ARP source IPv4 address. */
  OXM_TLV_BASIC_ARP_SPA_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                               (OFPXMT_OFB_ARP_SPA << 9) | 8 | HAS_MASK_FLAG,
  OXM_TLV_BASIC_ARP_TPA = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                          (OFPXMT_OFB_ARP_TPA << 9) |
                          4, /* ARP target IPv4 address. */
  OXM_TLV_BASIC_ARP_TPA_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                               (OFPXMT_OFB_ARP_TPA << 9) | 8 | HAS_MASK_FLAG,
  OXM_TLV_BASIC_ARP_SHA = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                          (OFPXMT_OFB_ARP_SHA << 9) |
                          6, /* ARP source hardware address. */
  OXM_TLV_BASIC_ARP_SHA_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                               (OFPXMT_OFB_ARP_SHA << 9) | 12 | HAS_MASK_FLAG,
  OXM_TLV_BASIC_ARP_THA = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                          (OFPXMT_OFB_ARP_THA << 9) |
                          6, /* ARP target hardware address. */
  OXM_TLV_BASIC_ARP_THA_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                               (OFPXMT_OFB_ARP_THA << 9) | 12 | HAS_MASK_FLAG,
  OXM_TLV_BASIC_IPV6_SRC =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IPV6_SRC << 9) | 16,
  /* IPv6 source address. */ // required
  OXM_TLV_BASIC_IPV6_SRC_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                                (OFPXMT_OFB_IPV6_SRC << 9) | 32 | HAS_MASK_FLAG,
  OXM_TLV_BASIC_IPV6_DST =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IPV6_DST << 9) | 16,
  /* IPv6 destination address. */ // required
  OXM_TLV_BASIC_IPV6_DST_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                                (OFPXMT_OFB_IPV6_DST << 9) | 32 | HAS_MASK_FLAG,
  OXM_TLV_BASIC_IPV6_FLABEL = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                              (OFPXMT_OFB_IPV6_FLABEL << 9) |
                              4, /* IPv6 Flow Label */
  OXM_TLV_BASIC_IPV6_FLABEL_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                                   (OFPXMT_OFB_IPV6_FLABEL << 9) | 8 |
                                   HAS_MASK_FLAG, /* IPv6 Flow Label */
  OXM_TLV_BASIC_ICMPV6_TYPE = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                              (OFPXMT_OFB_ICMPV6_TYPE << 9) |
                              1, /* ICMPv6 type. */
  OXM_TLV_BASIC_ICMPV6_CODE = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                              (OFPXMT_OFB_ICMPV6_CODE << 9) |
                              1, /* ICMPv6 code. */
  OXM_TLV_BASIC_IPV6_ND_TARGET = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                                 (OFPXMT_OFB_IPV6_ND_TARGET << 9) |
                                 16, /* Target address for ND. */
  OXM_TLV_BASIC_IPV6_ND_SLL = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                              (OFPXMT_OFB_IPV6_ND_SLL << 9) |
                              6, /* Source link-layer for ND. */
  OXM_TLV_BASIC_IPV6_ND_TLL = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                              (OFPXMT_OFB_IPV6_ND_TLL << 9) |
                              6, /* Target link-layer for ND. */
  OXM_TLV_BASIC_MPLS_LABEL = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                             (OFPXMT_OFB_MPLS_LABEL << 9) | 4, /* MPLS label. */
  OXM_TLV_BASIC_MPLS_TC = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                          (OFPXMT_OFB_MPLS_TC << 9) | 1, /* MPLS TC. */
  OXM_TLV_BASIC_MPLS_BOS = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                           (OFPXMT_OFB_MPLS_BOS << 9) | 1, /* MPLS BoS bit. */
  OXM_TLV_BASIC_PBB_ISID = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                           (OFPXMT_OFB_PBB_ISID << 9) | 3, /* PBB I-SID. */
  OXM_TLV_BASIC_PBB_ISID_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                                (OFPXMT_OFB_PBB_ISID << 9) | 6 | HAS_MASK_FLAG,
  OXM_TLV_BASIC_TUNNEL_ID = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                            (OFPXMT_OFB_TUNNEL_ID << 9) |
                            8, /* Logical Port Metadata. */
  OXM_TLV_BASIC_TUNNEL_ID_MASK = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                                 (OFPXMT_OFB_TUNNEL_ID << 9) | 16 |
                                 HAS_MASK_FLAG,
  OXM_TLV_BASIC_IPV6_EXTHDR = (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) |
                              (OFPXMT_OFB_IPV6_EXTHDR << 9) |
                              4, /* IPv6 Extension Header pseudo-field */
  OXM_TLV_BASIC_IPV6_EXTHDR_MASK =
      (uint32_t)(OFPXMC_OPENFLOW_BASIC << 16) | (OFPXMT_OFB_IPV6_EXTHDR << 9) |
      8 | HAS_MASK_FLAG, /* IPv6 Extension Header pseudo-field */
};
...
enum ofp_error_ids {
  /* HELLO_FAILED */
  OFPETC_HELLO_FAILED_INCOMPATIBLE =
      (OFPET_HELLO_FAILED << 16) |
      OFPHFC_INCOMPATIBLE, /* No compatible version. */
  OFPETC_HELLO_FAILED_EPERM =
      (OFPET_HELLO_FAILED << 16) | OFPHFC_EPERM, /* Permissions error. */

  /* BAD_REQUEST */
  OFPETC_BAD_REQUEST_BAD_VERSION =
      (OFPET_BAD_REQUEST << 16) |
      OFPBRC_BAD_VERSION, /* ofp_header.version not supported. */
  OFPETC_BAD_REQUEST_BAD_TYPE =
      (OFPET_BAD_REQUEST << 16) |
      OFPBRC_BAD_TYPE, /* ofp_header.type not supported. */
  OFPETC_BAD_REQUEST_BAD_STAT =
      (OFPET_BAD_REQUEST << 16) |
  ...
  OFPETC_BAD_REQUEST_EPERM =
      (OFPET_BAD_REQUEST << 16) | OFPBRC_EPERM, /* Permissions error. */
  OFPETC_BAD_REQUEST_BAD_LEN =
      (OFPET_BAD_REQUEST << 16) |
      OFPBRC_BAD_LEN, /* Wrong request length for type. */
  OFPETC_BAD_REQUEST_BUFFER_EMPTY =
      (OFPET_BAD_REQUEST << 16) |
      OFPBRC_BUFFER_EMPTY, /* Specified buffer has already been used. */
  OFPETC_BAD_REQUEST_BUFFER_UNKNOWN =
      (OFPET_BAD_REQUEST << 16) |
      OFPBRC_BUFFER_UNKNOWN, /* Specified buffer does not exist. */
  OFPETC_BAD_REQUEST_BAD_TABLE_ID =
      (OFPET_BAD_REQUEST << 16) |
      OFPBRC_BAD_TABLE_ID, /* Specified table-id invalid or does not exist. */
  OFPETC_BAD_REQUEST_IS_SLAVE =
      (OFPET_BAD_REQUEST << 16) |
      OFPBRC_IS_SLAVE, /* Denied because controller is slave. */
  OFPETC_BAD_REQUEST_BAD_PORT =
      (OFPET_BAD_REQUEST << 16) | OFPBRC_BAD_PORT, /* Invalid port. */
  OFPETC_BAD_REQUEST_BAD_PACKET =
      (OFPET_BAD_REQUEST << 16) |
  ...
  OFPETC_BAD_ACTION_BAD_TYPE =
      (OFPET_BAD_ACTION << 16) | OFPBAC_BAD_TYPE, /* Unknown action type. */
  OFPETC_BAD_ACTION_BAD_LEN = (OFPET_BAD_ACTION << 16) |
                              OFPBAC_BAD_LEN, /* Length problem in actions. */
  OFPETC_BAD_ACTION_BAD_EXPERIMENTER =
      (OFPET_BAD_ACTION << 16) |
      OFPBAC_BAD_EXPERIMENTER, /* Unknown experimenter id specified. */
  OFPETC_BAD_ACTION_BAD_EXP_TYPE =
      (OFPET_BAD_ACTION << 16) |
      OFPBAC_BAD_EXP_TYPE, /* Unknown action type for experimenter id. */
  OFPETC_BAD_ACTION_BAD_OUT_PORT =
      (OFPET_BAD_ACTION << 16) |
      OFPBAC_BAD_OUT_PORT, /* Problem validating output port. */
  OFPETC_BAD_ACTION_BAD_ARGUMENT =
      (OFPET_BAD_ACTION << 16) | OFPBAC_BAD_ARGUMENT, /* Bad action argument. */
  OFPETC_BAD_ACTION_EPERM =
      (OFPET_BAD_ACTION << 16) | OFPBAC_EPERM, /* Permissions error. */
  OFPETC_BAD_ACTION_TOO_MANY =
      (OFPET_BAD_ACTION << 16) |
      OFPBAC_TOO_MANY, /* Can't handle this many actions. */
  OFPETC_BAD_ACTION_BAD_QUEUE =
      (OFPET_BAD_ACTION << 16) |
      OFPBAC_BAD_QUEUE, /* Problem validating output queue. */
  OFPETC_BAD_ACTION_BAD_OUT_GROUP =
      (OFPET_BAD_ACTION << 16) |
      OFPBAC_BAD_OUT_GROUP, /* Invalid group id in forward action. */
  OFPETC_BAD_ACTION_MATCH_INCONSISTENT =
      (OFPET_BAD_ACTION << 16) |
  ...
  OFPETC_BAD_INSTRUCTION_UNSUP_METADATA =
      (OFPET_BAD_INSTRUCTION << 16) |
  ...
  OFPETC_BAD_INSTRUCTION_BAD_LEN =
      (OFPET_BAD_INSTRUCTION << 16) |
      OFPBIC_BAD_LEN, /* Length problem in instructions. */
  OFPETC_BAD_INSTRUCTION_EPERM =
      (OFPET_BAD_INSTRUCTION << 16) | OFPBIC_EPERM, /* Permissions error. */

  /* BAD_MATCH */
  OFPETC_BAD_MATCH_BAD_TYPE =
      (OFPET_BAD_MATCH << 16) |
      OFPBMC_BAD_TYPE, /* Unsupported match type specified by the match */
  OFPETC_BAD_MATCH_BAD_LEN =
      (OFPET_BAD_MATCH << 16) | OFPBMC_BAD_LEN, /* Length problem in match. */
  OFPETC_BAD_MATCH_BAD_TAG =
      (OFPET_BAD_MATCH << 16) |
  ...
  OFPETC_BAD_MATCH_DUP_FIELD =
      (OFPET_BAD_MATCH << 16) |
      OFPBMC_DUP_FIELD, /* A field type was duplicated. */
  OFPETC_BAD_MATCH_EPERM =
      (OFPET_BAD_MATCH << 16) | OFPBMC_EPERM, /* Permissions error. */

  /* FLOW_MOD_FAILED */
  OFPETC_FLOW_MOD_UNKNOWN =
      (OFPET_FLOW_MOD_FAILED << 16) | OFPFMFC_UNKNOWN, /* Unspecified error. */
  OFPETC_FLOW_MOD_TABLE_FULL =
      (OFPET_FLOW_MOD_FAILED << 16) |
      OFPFMFC_TABLE_FULL, /* Flow not added because table was full. */
  OFPETC_FLOW_MOD_BAD_TABLE_ID =
      (OFPET_FLOW_MOD_FAILED << 16) |
...
* idle/hard timeout. */
  ...
  OFPETC_GROUP_MOD_CHAINED_GROUP =
      ...
      OFPGMFC_CHAINED_GROUP, /* Group not deleted because another
        group is forwarding to it. */
  OFPETC_GROUP_MOD_BAD_TYPE =
      (OFPET_GROUP_MOD_FAILED << 16) |
      OFPGMFC_BAD_TYPE, /* Unsupported or unknown group type. */
  OFPETC_GROUP_MOD_BAD_COMMAND =
      (OFPET_GROUP_MOD_FAILED << 16) |
      OFPGMFC_BAD_COMMAND, /* Unsupported or unknown command. */
  OFPETC_GROUP_MOD_BAD_BUCKET = (OFPET_GROUP_MOD_FAILED << 16) |
                                OFPGMFC_BAD_BUCKET, /* Error in bucket. */
  OFPETC_GROUP_MOD_BAD_WATCH =
      (OFPET_GROUP_MOD_FAILED << 16) |
      OFPGMFC_BAD_WATCH, /* Error in watch port/group. */
  OFPETC_GROUP_MOD_EPERM =
      (OFPET_GROUP_MOD_FAILED << 16) | OFPGMFC_EPERM, /* Permissions error. */

  /* PORT_MOD_FAILED */
  OFPETC_PORT_MOD_BAD_PORT =
  ...
  OFPETC_PORT_MOD_BAD_ADVERTISE =
      (OFPET_PORT_MOD_FAILED << 16) |
      OFPPMFC_BAD_ADVERTISE, /* Specified advertise is invalid. */
  OFPETC_PORT_MOD_EPERM =
      (OFPET_PORT_MOD_FAILED << 16) | OFPPMFC_EPERM, /* Permissions error. */

  /* TABLE_MOD_FAILED */
  OFPETC_TABLE_MOD_BAD_TABLE =
      (OFPET_TABLE_MOD_FAILED << 16) |
      OFPTMFC_BAD_TABLE, /* Specified table does not exist. */
  OFPETC_TABLE_MOD_BAD_CONFIG =
      (OFPET_TABLE_MOD_FAILED << 16) |
      OFPTMFC_BAD_CONFIG, /* Specified config is invalid. */
  OFPETC_TABLE_MOD_EPERM =
      (OFPET_TABLE_MOD_FAILED << 16) | OFPTMFC_EPERM, /* Permissions error. */

  /* QUEUE_OP_FAILED */
  OFPETC_QUEUE_OP_BAD_PORT =
      (OFPET_QUEUE_OP_FAILED << 16) |
      OFPQOFC_BAD_PORT, /* Invalid port (or port does not exist). */
  OFPETC_QUEUE_OP_BAD_QUEUE = (OFPET_QUEUE_OP_FAILED << 16) |
                              OFPQOFC_BAD_QUEUE, /* Queue does not exist. */
  OFPETC_QUEUE_OP_EPERM =
      (OFPET_QUEUE_OP_FAILED << 16) | OFPQOFC_EPERM, /* Permissions error. */

  /* SWITCH_CONFIG_FAILED */
  OFPETC_SWITCH_CONFIG_BAD_FLAGS =
      (OFPET_SWITCH_CONFIG_FAILED << 16) |
      OFPSCFC_BAD_FLAGS, /* Specified flags is invalid. */
  OFPETC_SWITCH_CONFIG_BAD_LEN =
      (OFPET_SWITCH_CONFIG_FAILED << 16) |
      OFPSCFC_BAD_LEN, /* Specified len is invalid. */
  OFPETC_SWITCH_CONFIG_EPERM = (OFPET_SWITCH_CONFIG_FAILED << 16) |
                               OFPSCFC_EPERM, /* Permissions error. */

  /* ROLE_REQUEST */
  OFPETC_ROLE_REQUEST_STALE =
      (OFPET_ROLE_REQUEST_FAILED << 16) |
      OFPRRFC_STALE, /* Stale Message: old generation_id. */
  OFPETC_ROLE_REQUEST_UNSUP =
      (OFPET_ROLE_REQUEST_FAILED << 16) |
      OFPRRFC_UNSUP, /* Controller role change unsupported. */
  OFPETC_ROLE_REQUEST_BAD_ROLE =
      (OFPET_ROLE_REQUEST_FAILED << 16) | OFPRRFC_BAD_ROLE, /* Invalid role. */

  /* METER_MOD_FAILED */
  OFPETC_METER_MOD_UNKNOWN =
      (OFPET_METER_MOD_FAILED << 16) | OFPMMFC_UNKNOWN, /* Unspecified error. */
  ...
  OFPETC_METER_MOD_BAD_FLAGS =
      (OFPET_METER_MOD_FAILED << 16) |
      OFPMMFC_BAD_FLAGS, /* Flag configuration unsupported. */
  OFPETC_METER_MOD_BAD_RATE =
      (OFPET_METER_MOD_FAILED << 16) | OFPMMFC_BAD_RATE, /* Rate unsupported. */
  OFPETC_METER_MOD_BAD_BURST = (OFPET_METER_MOD_FAILED << 16) |
                               OFPMMFC_BAD_BURST, /* Burst size unsupported. */
  OFPETC_METER_MOD_BAD_BAND =
      (OFPET_METER_MOD_FAILED << 16) | OFPMMFC_BAD_BAND, /* Band unsupported. */
  OFPETC_METER_MOD_BAD_BAND_VALUE =
      (OFPET_METER_MOD_FAILED << 16) |
      OFPMMFC_BAD_BAND_VALUE, /* Band value unsupported. */
  OFPETC_METER_MOD_OUT_OF_METERS =
      (OFPET_METER_MOD_FAILED << 16) |
  ...
  OFPETC_TABLE_FEATURES_BAD_TABLE =
      (OFPET_TABLE_FEATURES_FAILED << 16) |
      OFPTFFC_BAD_TABLE, /* Specified table does not exist. */
  OFPETC_TABLE_FEATURES_BAD_METADATA =
      (OFPET_TABLE_FEATURES_FAILED << 16) |
      OFPTFFC_BAD_METADATA, /* Invalid metadata mask. */
  OFPETC_TABLE_FEATURES_BAD_TYPE =
      (OFPET_TABLE_FEATURES_FAILED << 16) |
      OFPTFFC_BAD_TYPE, /* Unknown property type. */
  OFPETC_TABLE_FEATURES_BAD_LEN =
      (OFPET_TABLE_FEATURES_FAILED << 16) |
      OFPTFFC_BAD_LEN, /* Length problem in properties. */
  OFPETC_TABLE_FEATURES_BAD_ARGUMENT =
      (OFPET_TABLE_FEATURES_FAILED << 16) |
      OFPTFFC_BAD_ARGUMENT, /* Unsupported property value. */
  OFPETC_TABLE_FEATURES_EPERM = (OFPET_TABLE_FEATURES_FAILED << 16) |
                                OFPTFFC_EPERM, /* Permissions error. */

  /* EXPERIMENTER */
  OFPETC_EXPERIMENTER =
      (OFPET_EXPERIMENTER << 16), /* Experimenter error messages. */
};
