...
public:
   ...
   *
   */
  cofaction_exp_body_gre(const cofaction_exp_body_gre &body) : cmemory(body) {}

  /**
   *
   */
  cofaction_exp_body_gre &operator=(const cofaction_exp_body_gre &body) {
    if (this == &body)
      return *this;
   ...
   *
   */
  cofaction_exp_body_gre(const rofl::cmemory &body) { *this = body; };

  /**
   *
   */
  cofaction_exp_body_gre &operator=(const rofl::cmemory &body) {
    if (this == &body)
      return *this;
    rofl::cmemory::operator=(body);
    return *this;
...
public:
  friend std::ostream &operator<<(std::ostream &os,
    ...
    os << "<cofaction_exp_body_gre exp-type: 0x" << std::hex
...
public:
   ...
   *
   */
  cofaction_exp_body_push_gre(uint16_t ethertype = 0)
      : cofaction_exp_body_gre(
            GRE_ACTION_PUSH_GRE,
   ...
   *
   */
  cofaction_exp_body_push_gre(const cofaction_exp_body_push_gre &action)
      : cofaction_exp_body_gre(action) {}

  /**
   *
   */
  cofaction_exp_body_push_gre &
  operator=(const cofaction_exp_body_push_gre &body) {
    if (this == &body)
      return *this;
    rofl::cmemory::operator=(body);
    return *this;
   ...
   *
   */
  cofaction_exp_body_push_gre(const rofl::cmemory &body) { *this = body; };

  /**
   *
   */
  cofaction_exp_body_push_gre &operator=(const rofl::cmemory &action) {
    if (this == &action)
      return *this;
...
public:
  friend std::ostream &operator<<(std::ostream &os,
                                  const cofaction_exp_body_push_gre &action) {
    os << "<cofaction_push_gre ether-type: 0x" << std::hex
...
public:
   ...
   *
   */
  cofaction_exp_body_pop_gre(uint16_t ethertype = 0)
      : cofaction_exp_body_gre(GRE_ACTION_POP_GRE,
   ...
   *
   */
  cofaction_exp_body_pop_gre(const cofaction_exp_body_pop_gre &action)
      : cofaction_exp_body_gre(action) {}
   ...
   */
  cofaction_exp_body_pop_gre &
  operator=(const cofaction_exp_body_pop_gre &body) {
    if (this == &body)
      return *this;
    rofl::cmemory::operator=(body);
    return *this;
   ...
   *
   */
  cofaction_exp_body_pop_gre(const rofl::cmemory &body) { *this = body; };

  /**
   *
   */
  cofaction_exp_body_pop_gre &operator=(const rofl::cmemory &action) {
    if (this == &action)
      return *this;
    rofl::cmemory::operator=(action);
    return *this;
...
public:
  friend std::ostream &operator<<(std::ostream &os,
                                  const cofaction_exp_body_pop_gre &action) {
    os << "<cofaction_pop_gre ether-type: 0x" << std::hex
       << (unsigned int)action.get_ether_type() << std::dec << ">" << std::endl;
