...
cofmsg_port_desc_stats_request::cofmsg_port_desc_stats_request(
    ...
    : cofmsg_stats_request(version, xid, rofl::openflow::OFPMP_PORT_DESC,
                           stats_flags) {}
...
cofmsg_port_desc_stats_request &cofmsg_port_desc_stats_request::
operator=(const cofmsg_port_desc_stats_request &msg) {
  if (this == &msg)
    return *this;
...
size_t cofmsg_port_desc_stats_request::length() const {
  switch (get_version()) {
...
void cofmsg_port_desc_stats_request::pack(uint8_t *buf, size_t buflen) {
...
void cofmsg_port_desc_stats_request::unpack(uint8_t *buf, size_t buflen) {
...
cofmsg_port_desc_stats_reply::cofmsg_port_desc_stats_reply(
    ...
    : cofmsg_stats_reply(version, xid, rofl::openflow::OFPMP_PORT_DESC,
                         stats_flags),
      ports(ports) {
...
cofmsg_port_desc_stats_reply::cofmsg_port_desc_stats_reply(
    ...
    : cofmsg_stats_reply(msg), ports(msg.ports) {}

cofmsg_port_desc_stats_reply &cofmsg_port_desc_stats_reply::
operator=(const cofmsg_port_desc_stats_reply &msg) {
  if (this == &msg)
    return *this;
...
size_t cofmsg_port_desc_stats_reply::length() const {
  switch (get_version()) {
  case openflow13::OFP_VERSION: {
...
void cofmsg_port_desc_stats_reply::pack(uint8_t *buf, size_t buflen) {
...
void cofmsg_port_desc_stats_reply::unpack(uint8_t *buf, size_t buflen) {
