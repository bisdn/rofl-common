 ...
 *
 */
class cofmsg_port_desc_stats_request : public cofmsg_stats_request {
public:
  /**
   *
   */
   ...
   *
   */
  cofmsg_port_desc_stats_request(const cofmsg_port_desc_stats_request &msg);
...
public:
  friend std::ostream &operator<<(std::ostream &os,
    ...
    os << "<cofmsg_port_desc_stats_request >" << std::endl;
    return os;
  };
 ...
 *
 */
class cofmsg_port_desc_stats_reply : public cofmsg_stats_reply {
public:
  /**
   *
   */
   ...
   *
   */
  cofmsg_port_desc_stats_reply(const cofmsg_port_desc_stats_reply &msg);
...
public:
  friend std::ostream &operator<<(std::ostream &os,
    ...
    os << "<cofmsg_port_desc_stats_reply >" << std::endl;
