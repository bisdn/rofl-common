...
cofmsg_flow_stats_request::cofmsg_flow_stats_request(
    ...
    : cofmsg_stats_request(version, xid, rofl::openflow::OFPMP_FLOW,
                           stats_flags),
...
cofmsg_flow_stats_request::cofmsg_flow_stats_request(
    ...
    : cofmsg_stats_request(msg), flow_stats(msg.flow_stats) {}

cofmsg_flow_stats_request &cofmsg_flow_stats_request::
operator=(const cofmsg_flow_stats_request &msg) {
  if (this == &msg)
    return *this;
...
size_t cofmsg_flow_stats_request::length() const {
  switch (get_version()) {
...
void cofmsg_flow_stats_request::pack(uint8_t *buf, size_t buflen) {
...
void cofmsg_flow_stats_request::unpack(uint8_t *buf, size_t buflen) {
...
cofmsg_flow_stats_reply &cofmsg_flow_stats_reply::
operator=(const cofmsg_flow_stats_reply &msg) {
  if (this == &msg)
    return *this;
...
size_t cofmsg_flow_stats_reply::length() const {
  switch (get_version()) {
  case rofl::openflow10::OFP_VERSION: {
    return (sizeof(struct rofl::openflow10::ofp_stats_reply) +
            flowstatsarray.length());
  } break;
  default: {
...
void cofmsg_flow_stats_reply::pack(uint8_t *buf, size_t buflen) {
...
void cofmsg_flow_stats_reply::unpack(uint8_t *buf, size_t buflen) {
