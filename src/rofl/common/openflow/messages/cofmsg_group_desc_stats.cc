		...
		uint8_t *buf, size_t buflen)
{
	...
	if (buflen < cofmsg_group_desc_stats_request::length())
		throw eBadRequestBadLen("cofmsg_group_desc_stats_request::unpack() buf too short");
		...
		uint8_t *buf, size_t buflen)
{
	...
	if (buflen < cofmsg_group_desc_stats_reply::length())
		throw eBadRequestBadLen("cofmsg_group_desc_stats_reply::unpack() buf too short");
