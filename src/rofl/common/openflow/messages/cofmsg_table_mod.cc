...
cofmsg_table_mod::cofmsg_table_mod(uint8_t version, uint32_t xid,
...
size_t cofmsg_table_mod::length() const {
  switch (get_version()) {
...
void cofmsg_table_mod::pack(uint8_t *buf, size_t buflen) {
...
void cofmsg_table_mod::unpack(uint8_t *buf, size_t buflen) {
