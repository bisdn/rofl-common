 ...
 *
 */
class cofmsg_queue_stats_request : public cofmsg_stats_request {
public:
  /**
   *
   */
  ...
  cofmsg_queue_stats_request(
      uint8_t version = 0, uint32_t xid = 0, uint16_t flags = 0,
   ...
   *
   */
  cofmsg_queue_stats_request(const cofmsg_queue_stats_request &msg);

  /**
   *
   */
  cofmsg_queue_stats_request &operator=(const cofmsg_queue_stats_request &msg);
...
public:
   ...
   *
   */
  const rofl::openflow::cofqueue_stats_request &get_queue_stats() const {
    return queue_stats;
  };
   ...
   *
   */
  rofl::openflow::cofqueue_stats_request &set_queue_stats() {
    return queue_stats;
  };

public:
  friend std::ostream &operator<<(std::ostream &os,
                                  cofmsg_queue_stats_request const &msg) {
 ...
 *
 */
class cofmsg_queue_stats_reply : public cofmsg_stats_reply {
public:
  /**
   *
   */
  ...
  cofmsg_queue_stats_reply(
      uint8_t of_version = 0, uint32_t xid = 0, uint16_t flags = 0,
      const rofl::openflow::cofqueuestatsarray &queue_stats =
          rofl::openflow::cofqueuestatsarray());

  /**
   *
   */
  cofmsg_queue_stats_reply(const cofmsg_queue_stats_reply &msg);

  /**
   *
   */
  cofmsg_queue_stats_reply &operator=(const cofmsg_queue_stats_reply &msg);
...
public:
   ...
   *
   */
  const rofl::openflow::cofqueuestatsarray &get_queue_stats_array() const {
   ...
   *
   */
  rofl::openflow::cofqueuestatsarray &set_queue_stats_array() {
    return queuestatsarray;
  };

public:
  friend std::ostream &operator<<(std::ostream &os,
                                  cofmsg_queue_stats_reply const &msg) {
    os << dynamic_cast<cofmsg const &>(msg);
