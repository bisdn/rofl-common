...
public:
	...
	operator<< (std::ostream& os, cofmsg_error const& msg) {
		...
		case OFPETC_HELLO_FAILED_INCOMPATIBLE: {
			os << "<error-id: 0x" << (int)error_id << " HELLO-FAILED-INCOMPATIBLE >" << std::endl;
		} break;
		case OFPETC_HELLO_FAILED_EPERM: {
			os << "<error-id: 0x" << (int)error_id << " HELLO-FAILED-EPERM >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_BAD_VERSION: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-BAD-VERSION >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_BAD_TYPE: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-BAD-TYPE >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_BAD_STAT: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-BAD-STAT >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_BAD_EXPERIMENTER: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-BAD-EXPERIMENTER >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_BAD_EXP_TYPE: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-BAD-EXP-TYPE >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_EPERM: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-EPERM >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_BAD_LEN: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-BAD-LEN >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_BUFFER_EMPTY: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-BUFFER-EMPTY >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_BUFFER_UNKNOWN: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-BUFFER-UNKNOWN >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_BAD_TABLE_ID: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-BAD-TABLE-ID >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_IS_SLAVE: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-IS-SLAVE >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_BAD_PORT: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-BAD-PORT >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_BAD_PACKET: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-BAD-PACKET >" << std::endl;
		} break;
		case OFPETC_BAD_REQUEST_MULTIPART_BUFFER_OVERFLOW: {
			os << "<error-id: 0x" << (int)error_id << " BAD-REQUEST-MULTIPART-BUFFER-OVERFLOW >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_BAD_TYPE: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-BAD-TYPE >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_BAD_LEN: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-BAD-LEN >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_BAD_EXPERIMENTER: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-BAD-EXPERIMENTER >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_BAD_EXP_TYPE: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-BAD-EXP-TYPE >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_BAD_OUT_PORT: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-BAD-OUT-PORT >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_BAD_ARGUMENT: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-BAD-ARGUMENT >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_EPERM: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-EPERM >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_TOO_MANY: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-TOO-MANY >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_BAD_QUEUE: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-BAD-QUEUE >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_BAD_OUT_GROUP: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-BAD-OUT-GROUP >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_MATCH_INCONSISTENT: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-MATCH-INCONSISTENT >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_UNSUPPORTED_ORDER: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-UNSUPPORTED-ORDER >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_BAD_TAG: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-BAD-TAG >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_BAD_SET_TYPE: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-BAD-SET-TYPE >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_BAD_SET_LEN: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-BAD-SET-LEN >" << std::endl;
		} break;
		case OFPETC_BAD_ACTION_BAD_SET_ARGUMENT: {
			os << "<error-id: 0x" << (int)error_id << " BAD-ACTION-BAD-SET-ARGUMENT >" << std::endl;
		} break;
		case OFPETC_BAD_INSTRUCTION_UNKNOWN_INST: {
			os << "<error-id: 0x" << (int)error_id << " BAD-INSTRUCTION-UNKNOWN-INST >" << std::endl;
		} break;
		case OFPETC_BAD_INSTRUCTION_UNSUP_INST: {
			os << "<error-id: 0x" << (int)error_id << " BAD-INSTRUCTION-UNSUP-INST >" << std::endl;
		} break;
		case OFPETC_BAD_INSTRUCTION_BAD_TABLE_ID: {
			os << "<error-id: 0x" << (int)error_id << " BAD-INSTRUCTION-BAD-TABLE-ID >" << std::endl;
		} break;
		case OFPETC_BAD_INSTRUCTION_UNSUP_METADATA: {
			os << "<error-id: 0x" << (int)error_id << " BAD-INSTRUCTION-UNSUP-METADATA >" << std::endl;
		} break;
		case OFPETC_BAD_INSTRUCTION_UNSUP_METADATA_MASK: {
			os << "<error-id: 0x" << (int)error_id << " BAD-INSTRUCTION-UNSUP-METADATA-MASK >" << std::endl;
		} break;
		case OFPETC_BAD_INSTRUCTION_BAD_EXPERIMENTER: {
			os << "<error-id: 0x" << (int)error_id << " BAD-INSTRUCTION-BAD-EXPERIMENTER >" << std::endl;
		} break;
		case OFPETC_BAD_INSTRUCTION_BAD_EXP_TYPE: {
			os << "<error-id: 0x" << (int)error_id << " BAD-INSTRUCTION-BAD-EXP-TYPE >" << std::endl;
		} break;
		case OFPETC_BAD_INSTRUCTION_BAD_LEN: {
			os << "<error-id: 0x" << (int)error_id << " BAD-INSTRUCTION-BAD-LEN >" << std::endl;
		} break;
		case OFPETC_BAD_INSTRUCTION_EPERM: {
			os << "<error-id: 0x" << (int)error_id << " BAD-INSTRUCTION-EPERM >" << std::endl;
		} break;
		case OFPETC_BAD_MATCH_BAD_TYPE: {
			os << "<error-id: 0x" << (int)error_id << " BAD-MATCH-BAD-TYPE >" << std::endl;
		} break;
		case OFPETC_BAD_MATCH_BAD_LEN: {
			os << "<error-id: 0x" << (int)error_id << " BAD-MATCH-BAD-LEN >" << std::endl;
		} break;
		case OFPETC_BAD_MATCH_BAD_TAG: {
			os << "<error-id: 0x" << (int)error_id << " BAD-MATCH-BAD-TAG >" << std::endl;
		} break;
		case OFPETC_BAD_MATCH_BAD_DL_ADDR_MASK: {
			os << "<error-id: 0x" << (int)error_id << " BAD-MATCH-BAD-DL-ADDR-MASK >" << std::endl;
		} break;
		case OFPETC_BAD_MATCH_BAD_NW_ADDR_MASK: {
			os << "<error-id: 0x" << (int)error_id << " BAD-MATCH-BAD-NW-ADDR-MASK >" << std::endl;
		} break;
		case OFPETC_BAD_MATCH_BAD_WILDCARDS: {
			os << "<error-id: 0x" << (int)error_id << " BAD-MATCH-BAD-WILDCARDS >" << std::endl;
		} break;
		case OFPETC_BAD_MATCH_BAD_FIELD: {
			os << "<error-id: 0x" << (int)error_id << " BAD-MATCH-BAD-FIELD >" << std::endl;
		} break;
		case OFPETC_BAD_MATCH_BAD_VALUE: {
			os << "<error-id: 0x" << (int)error_id << " BAD-MATCH-BAD-VALUE >" << std::endl;
		} break;
		case OFPETC_BAD_MATCH_BAD_MASK: {
			os << "<error-id: 0x" << (int)error_id << " BAD-MATCH-BAD-MASK >" << std::endl;
		} break;
		case OFPETC_BAD_MATCH_BAD_PREREQ: {
			os << "<error-id: 0x" << (int)error_id << " BAD-MATCH-BAD-PREREQ >" << std::endl;
		} break;
		case OFPETC_BAD_MATCH_DUP_FIELD: {
			os << "<error-id: 0x" << (int)error_id << " BAD-MATCH-DUP-FIELD >" << std::endl;
		} break;
		case OFPETC_BAD_MATCH_EPERM: {
			os << "<error-id: 0x" << (int)error_id << " BAD-MATCH-EPERM >" << std::endl;
		} break;
		case OFPETC_FLOW_MOD_UNKNOWN: {
			os << "<error-id: 0x" << (int)error_id << " FLOW-MOD-UNKNOWN >" << std::endl;
		} break;
		case OFPETC_FLOW_MOD_TABLE_FULL: {
			os << "<error-id: 0x" << (int)error_id << " FLOW-MOD-TABLE-FULL >" << std::endl;
		} break;
		case OFPETC_FLOW_MOD_BAD_TABLE_ID: {
			os << "<error-id: 0x" << (int)error_id << " FLOW-MOD-BAD-TABLE-ID >" << std::endl;
		} break;
		case OFPETC_FLOW_MOD_OVERLAP: {
			os << "<error-id: 0x" << (int)error_id << " FLOW-MOD-OVERLAP >" << std::endl;
		} break;
		case OFPETC_FLOW_MOD_EPERM: {
			os << "<error-id: 0x" << (int)error_id << " FLOW-MOD-EPERM >" << std::endl;
		} break;
		case OFPETC_FLOW_MOD_BAD_TIMEOUT: {
			os << "<error-id: 0x" << (int)error_id << " FLOW-MOD-BAD-TIMEOUT >" << std::endl;
		} break;
		case OFPETC_FLOW_MOD_BAD_COMMAND: {
			os << "<error-id: 0x" << (int)error_id << " FLOW-MOD-BAD-COMMAND >" << std::endl;
		} break;
		case OFPETC_FLOW_MOD_BAD_FLAGS: {
			os << "<error-id: 0x" << (int)error_id << " FLOW-MOD-BAD-FLAGS >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_GROUP_EXISTS: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-GROUP-EXISTS >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_INVALID_GROUP: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-INVALID-GROUP >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_WEIGHT_UNSUPPORTED: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-WEIGHT-UNSUPPORTED >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_OUT_OF_GROUPS: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-OUT-OF-GROUPS >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_OUT_OF_BUCKETS: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-OUT-OF-BUCKETS >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_CHAINING_UNSUPPORTED: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-CHAINING-UNSUPPORTED >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_WATCH_UNSUPPORTED: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-WATCH-UNSUPPORTED >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_LOOP: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-LOOP >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_UNKNOWN_GROUP: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-UNKNOWN-GROUP >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_CHAINED_GROUP: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-CHAINED-GROUP >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_BAD_TYPE: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-BAD-TYPE >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_BAD_COMMAND: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-BAD-COMMAND >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_BAD_BUCKET: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-BAD-BUCKET >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_BAD_WATCH: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-BAD-WATCH >" << std::endl;
		} break;
		case OFPETC_GROUP_MOD_EPERM: {
			os << "<error-id: 0x" << (int)error_id << " GROUP-MOD-EPERM >" << std::endl;
		} break;
		case OFPETC_PORT_MOD_BAD_PORT: {
			os << "<error-id: 0x" << (int)error_id << " PORT-MOD-BAD-PORT >" << std::endl;
		} break;
		case OFPETC_PORT_MOD_BAD_HW_ADDR: {
			os << "<error-id: 0x" << (int)error_id << " PORT-MOD-BAD-HW-ADDR >" << std::endl;
		} break;
		case OFPETC_PORT_MOD_BAD_CONFIG: {
			os << "<error-id: 0x" << (int)error_id << " PORT-MOD-BAD-CONFIG >" << std::endl;
		} break;
		case OFPETC_PORT_MOD_BAD_ADVERTISE: {
			os << "<error-id: 0x" << (int)error_id << " PORT-MOD-BAD-ADVERTISE >" << std::endl;
		} break;
		case OFPETC_PORT_MOD_EPERM: {
			os << "<error-id: 0x" << (int)error_id << " PORT-MOD-EPERM >" << std::endl;
		} break;
		case OFPETC_TABLE_MOD_BAD_TABLE: {
			os << "<error-id: 0x" << (int)error_id << " TABLE-MOD-BAD-TABLE >" << std::endl;
		} break;
		case OFPETC_TABLE_MOD_BAD_CONFIG: {
			os << "<error-id: 0x" << (int)error_id << " TABLE-MOD-BAD-CONFIG >" << std::endl;
		} break;
		case OFPETC_TABLE_MOD_EPERM: {
			os << "<error-id: 0x" << (int)error_id << " TABLE-MOD-EPERM >" << std::endl;
		} break;
		case OFPETC_QUEUE_OP_BAD_PORT: {
			os << "<error-id: 0x" << (int)error_id << " QUEUE-OP-BAD-PORT >" << std::endl;
		} break;
		case OFPETC_QUEUE_OP_BAD_QUEUE: {
			os << "<error-id: 0x" << (int)error_id << " QUEUE-OP-BAD-QUEUE >" << std::endl;
		} break;
		case OFPETC_QUEUE_OP_EPERM: {
			os << "<error-id: 0x" << (int)error_id << " QUEUE-OP-EPERM >" << std::endl;
		} break;
		case OFPETC_SWITCH_CONFIG_BAD_FLAGS: {
			os << "<error-id: 0x" << (int)error_id << " SWITCH-CONFIG-BAD-FLAGS >" << std::endl;
		} break;
		case OFPETC_SWITCH_CONFIG_BAD_LEN: {
			os << "<error-id: 0x" << (int)error_id << " SWITCH-CONFIG-BAD-LEN >" << std::endl;
		} break;
		case OFPETC_SWITCH_CONFIG_EPERM: {
			os << "<error-id: 0x" << (int)error_id << " SWITCH-CONFIG-EPERM >" << std::endl;
		} break;
		case OFPETC_ROLE_REQUEST_STALE: {
			os << "<error-id: 0x" << (int)error_id << " ROLE-REQUEST-STALE >" << std::endl;
		} break;
		case OFPETC_ROLE_REQUEST_UNSUP: {
			os << "<error-id: 0x" << (int)error_id << " ROLE-REQUEST-UNSUP >" << std::endl;
		} break;
		case OFPETC_ROLE_REQUEST_BAD_ROLE: {
			os << "<error-id: 0x" << (int)error_id << " ROLE-REQUEST-BAD-ROLE >" << std::endl;
		} break;
		case OFPETC_METER_MOD_UNKNOWN: {
			os << "<error-id: 0x" << (int)error_id << " METER-MOD-UNKNOWN >" << std::endl;
		} break;
		case OFPETC_METER_MOD_METER_EXISTS: {
			os << "<error-id: 0x" << (int)error_id << " METER-MOD-METER-EXISTS >" << std::endl;
		} break;
		case OFPETC_METER_MOD_INVALID_METER: {
			os << "<error-id: 0x" << (int)error_id << " METER-MOD-INVALID-METER >" << std::endl;
		} break;
		case OFPETC_METER_MOD_UNKNOWN_METER: {
			os << "<error-id: 0x" << (int)error_id << " METER-MOD-UNKNOWN-METER >" << std::endl;
		} break;
		case OFPETC_METER_MOD_BAD_COMMAND: {
			os << "<error-id: 0x" << (int)error_id << " METER-MOD-BAD-COMMAND >" << std::endl;
		} break;
		case OFPETC_METER_MOD_BAD_FLAGS: {
			os << "<error-id: 0x" << (int)error_id << " METER-MOD-BAD-FLAGS >" << std::endl;
		} break;
		case OFPETC_METER_MOD_BAD_RATE: {
			os << "<error-id: 0x" << (int)error_id << " METER-MOD-BAD-RATE >" << std::endl;
		} break;
		case OFPETC_METER_MOD_BAD_BURST: {
			os << "<error-id: 0x" << (int)error_id << " METER-MOD-BAD-BURST >" << std::endl;
		} break;
		case OFPETC_METER_MOD_BAD_BAND: {
			os << "<error-id: 0x" << (int)error_id << " METER-MOD-BAD-BAND >" << std::endl;
		} break;
		case OFPETC_METER_MOD_BAD_BAND_VALUE: {
			os << "<error-id: 0x" << (int)error_id << " METER-MOD-BAD-BAND-VALUE >" << std::endl;
		} break;
		case OFPETC_METER_MOD_OUT_OF_METERS: {
			os << "<error-id: 0x" << (int)error_id << " METER-MOD-OUT-OF-METERS >" << std::endl;
		} break;
		case OFPETC_METER_MOD_OUT_OF_BANDS: {
			os << "<error-id: 0x" << (int)error_id << " METER-MOD-OUT-OF-BANDS >" << std::endl;
		} break;
		case OFPETC_TABLE_FEATURES_BAD_TABLE: {
			os << "<error-id: 0x" << (int)error_id << " TABLE-FEATURES-BAD-TABLE >" << std::endl;
		} break;
		case OFPETC_TABLE_FEATURES_BAD_METADATA: {
			os << "<error-id: 0x" << (int)error_id << " TABLE-FEATURES-BAD-METADATA >" << std::endl;
		} break;
		case OFPETC_TABLE_FEATURES_BAD_TYPE: {
			os << "<error-id: 0x" << (int)error_id << " TABLE-FEATURES-BAD-TYPE >" << std::endl;
		} break;
		case OFPETC_TABLE_FEATURES_BAD_LEN: {
			os << "<error-id: 0x" << (int)error_id << " TABLE-FEATURES-BAD-LEN >" << std::endl;
		} break;
		case OFPETC_TABLE_FEATURES_BAD_ARGUMENT: {
			os << "<error-id: 0x" << (int)error_id << " TABLE-FEATURES-BAD-ARGUMENT >" << std::endl;
		} break;
		case OFPETC_TABLE_FEATURES_EPERM: {
			os << "<error-id: 0x" << (int)error_id << " TABLE-FEATURES-EPERM >" << std::endl;
		} break;
