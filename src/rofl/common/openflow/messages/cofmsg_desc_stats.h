...
public:
	...
	friend std::ostream&
	operator<< (std::ostream& os, const cofmsg_desc_stats_request& msg) {
...
public:
	 ...
	 *
	 */
	const cofdesc_stats_reply&
	get_desc_stats() const
	{ return desc_stats; };
...
public:
	...
	friend std::ostream&
	operator<< (std::ostream& os, const cofmsg_desc_stats_reply& msg) {
