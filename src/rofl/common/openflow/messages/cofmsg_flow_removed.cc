...
/*static*/ const size_t cofmsg_flow_removed::OFP13_FLOW_REMOVED_STATIC_HDR_LEN =
    sizeof(struct rofl::openflow13::ofp_flow_removed) -
    sizeof(struct rofl::openflow13::ofp_match);
...
void cofmsg_flow_removed::pack(uint8_t *buf, size_t buflen) {
...
void cofmsg_flow_removed::unpack(uint8_t *buf, size_t buflen) {
