 ...
 *
 */
class cofmsg_group_features_stats_request : public cofmsg_stats_request {
public:
  /**
   *
   */
 ...
 *
 */
class cofmsg_group_features_stats_reply : public cofmsg_stats_reply {
public:
  /**
   *
   */
  ...
  cofmsg_group_features_stats_reply(
      ...
      const rofl::openflow::cofgroup_features_stats_reply
          &group_features_stats =
              rofl::openflow::cofgroup_features_stats_reply());
...
public:
   ...
   *
   */
  const cofgroup_features_stats_reply &get_group_features_stats() const {
   ...
   *
   */
  cofgroup_features_stats_reply &set_group_features_stats() {
    return group_features_stats;
  };
