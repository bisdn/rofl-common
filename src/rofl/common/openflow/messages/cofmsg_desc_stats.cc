...
cofmsg_desc_stats_request::cofmsg_desc_stats_request(uint8_t version,
                                                     uint32_t xid,
                                                     uint16_t stats_flags)
    : cofmsg_stats_request(version, xid, rofl::openflow::OFPMP_DESC,
                           stats_flags) {
  switch (version) {
...
size_t cofmsg_desc_stats_request::length() const {
  switch (get_version()) {
  case rofl::openflow10::OFP_VERSION: {
...
void cofmsg_desc_stats_request::pack(uint8_t *buf, size_t buflen) {
...
size_t cofmsg_desc_stats_reply::length() const {
  switch (get_version()) {
  case rofl::openflow10::OFP_VERSION: {
...
void cofmsg_desc_stats_reply::pack(uint8_t *buf, size_t buflen) {
...
void cofmsg_desc_stats_reply::unpack(uint8_t *buf, size_t buflen) {
