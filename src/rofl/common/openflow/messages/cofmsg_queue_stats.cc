...
cofmsg_queue_stats_request::cofmsg_queue_stats_request(
    ...
    : cofmsg_stats_request(version, xid, rofl::openflow::OFPMP_QUEUE,
                           stats_flags),
...
size_t cofmsg_queue_stats_request::length() const {
  switch (get_version()) {
...
void cofmsg_queue_stats_request::pack(uint8_t *buf, size_t buflen) {
...
void cofmsg_queue_stats_request::unpack(uint8_t *buf, size_t buflen) {
...
cofmsg_queue_stats_reply::cofmsg_queue_stats_reply(
    ...
    : cofmsg_stats_reply(version, xid, rofl::openflow::OFPMP_QUEUE,
                         stats_flags),
...
size_t cofmsg_queue_stats_reply::length() const {
  switch (get_version()) {
  case rofl::openflow10::OFP_VERSION: {
    return (sizeof(struct rofl::openflow10::ofp_stats_reply) +
            queuestatsarray.length());
  } break;
  case rofl::openflow12::OFP_VERSION: {
...
void cofmsg_queue_stats_reply::pack(uint8_t *buf, size_t buflen) {
...
void cofmsg_queue_stats_reply::unpack(uint8_t *buf, size_t buflen) {
