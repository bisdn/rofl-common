...
public:
   ...
   *
   */
  cofmsg_group_mod(uint8_t version = rofl::openflow::OFP_VERSION_UNKNOWN,
                   uint32_t xid = 0,
   ...
   *
   */
  cofmsg_group_mod &operator=(const cofmsg_group_mod &msg) {
    if (this == &msg)
      return *this;
    cofmsg::operator=(msg);
...
public:
   ...
   *
   */
  void check_prerequisites() const { groupmod.check_prerequisites(); };
...
public:
   ...
   *
   */
  rofl::openflow::cofgroupmod &set_groupmod() { return groupmod; };

  /**
   *
   */
  const rofl::openflow::cofgroupmod &get_groupmod() const { return groupmod; };
