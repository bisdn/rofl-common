...
void cofportdesc_prop::pack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
void cofportdesc_prop::unpack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
void cofportdesc_prop_ethernet::pack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
void cofportdesc_prop_ethernet::unpack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
void cofportdesc_prop_optical::pack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
void cofportdesc_prop_optical::unpack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
void cofportdesc_prop_experimenter::pack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
void cofportdesc_prop_experimenter::unpack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
  ...
  case rofl::openflow14::OFP_VERSION: {
    ...
    exp_body.unpack(
        (uint8_t *)hdr->experimenter_data,
        get_length() -
            sizeof(struct rofl::openflow14::ofp_port_desc_prop_experimenter));
