...
public:
	 ...
	 */
	cofmeter_stats_request(
			const cofmeter_stats_request& req)
	{ *this = req; };
	...
	const bool
	operator== (
			const cofmeter_stats_request& req) const
...
public:
	 ...
	 */
	cofmeter_stats_reply(
			const cofmeter_stats_reply& rep)
	{ *this = rep; };
...
public:
	...
	set_packet_in_count(
			uint64_t packet_in_count)
	{ this->packet_in_count = packet_in_count; return *this; };

	/**
	 *
	 */
	uint64_t
	get_packet_in_count() const
	...
	set_byte_in_count(
			uint64_t byte_in_count)
	{ this->byte_in_count = byte_in_count; return *this; };

	/**
	 *
	 */
	uint64_t
	get_byte_in_count() const
