...
public:
  eGroupModBase(const std::string &__arg) : exception(__arg){};
};
...
public:
  ...
  cofgroupmod(
      ...
      uint16_t command = 0, uint8_t type = 0, uint32_t group_id = 0,
      const rofl::openflow::cofbuckets &buckets = rofl::openflow::cofbuckets())
      : ofp_version(version), command(command), type(type), group_id(group_id),
        buckets(buckets) {
   ...
   *
   */
  cofgroupmod(const cofgroupmod &groupmod) { *this = groupmod; };

  /**
   *
   */
  cofgroupmod &operator=(const cofgroupmod &groupmod) {
    if (this == &groupmod)
      return *this;
...
public:
   ...
   *
   */
  void check_prerequisites() const { buckets.check_prerequisites(); };
...
public:
   ...
   *
   */
  cofbuckets const &get_buckets() const { return buckets; };

public:
  friend std::ostream &operator<<(std::ostream &os,
                                  cofgroupmod const &groupmod) {
    os << "<cofgroupmod ";
    os << "cmd:";
    ...
    case rofl::openflow13::OFP_VERSION: {
      ...
      case rofl::openflow13::OFPGC_ADD:
        os << "ADD ";
        break;
      case rofl::openflow13::OFPGC_MODIFY:
        os << "MODIFY ";
        break;
      case rofl::openflow13::OFPGC_DELETE:
        os << "DELETE ";
        break;
      default:
        os << "UNKNOWN ";
      ...
      case rofl::openflow13::OFPGT_ALL:
        os << "ALL ";
        break;
      case rofl::openflow13::OFPGT_SELECT:
        os << "SELECT ";
        break;
      case rofl::openflow13::OFPGT_INDIRECT:
        os << "INDIRECT ";
        break;
      case rofl::openflow13::OFPGT_FF:
        os << "FAST-FAILOVER ";
        break;
      default:
        os << "UNKNOWN ";
