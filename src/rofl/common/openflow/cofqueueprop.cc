...
size_t cofqueue_prop::length() const {
  switch (ofp_version) {
...
void cofqueue_prop::pack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
void cofqueue_prop::unpack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
size_t cofqueue_prop_min_rate::length() const {
  switch (get_version()) {
  case rofl::openflow10::OFP_VERSION:
  case rofl::openflow12::OFP_VERSION:
  case rofl::openflow13::OFP_VERSION: {
...
void cofqueue_prop_min_rate::pack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
void cofqueue_prop_min_rate::unpack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
size_t cofqueue_prop_max_rate::length() const {
  switch (get_version()) {
  case rofl::openflow10::OFP_VERSION:
  case rofl::openflow12::OFP_VERSION:
  case rofl::openflow13::OFP_VERSION: {
...
void cofqueue_prop_max_rate::pack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
void cofqueue_prop_max_rate::unpack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
size_t cofqueue_prop_experimenter::length() const {
  switch (get_version()) {
  case rofl::openflow10::OFP_VERSION:
  case rofl::openflow12::OFP_VERSION:
  case rofl::openflow13::OFP_VERSION: {
    return (sizeof(struct rofl::openflow13::ofp_queue_prop_experimenter) +
            exp_body.memlen());
  } break;
  default:
    throw eBadVersion("eBadVersion", __FILE__, __PRETTY_FUNCTION__, __LINE__);
...
void cofqueue_prop_experimenter::pack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
...
void cofqueue_prop_experimenter::unpack(uint8_t *buf, size_t buflen) {
  if ((0 == buf) || (0 == buflen))
    return;
  ...
  case rofl::openflow13::OFP_VERSION: {
    ...
    exp_body.unpack(
        hdr->data,
        get_length() -
            sizeof(struct rofl::openflow13::ofp_queue_prop_experimenter));
