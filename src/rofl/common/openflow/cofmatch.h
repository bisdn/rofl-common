...
public:
	...
	uint8_t  get_nw_proto() const {
	 return static_cast<const coxmatch_8*>(matches.get_match(rofl::openflow::experimental::OXM_TLV_EXPR_NW_PROTO))->get_u8value();
	};
	uint8_t  get_nw_tos() const {
	 return static_cast<const coxmatch_8*>(matches.get_match(rofl::openflow::experimental::OXM_TLV_EXPR_NW_TOS))->get_u8value();
	};
	caddress_in4 get_nw_src() const {
	 return static_cast<const coxmatch_32*>(matches.get_match(rofl::openflow::experimental::OXM_TLV_EXPR_NW_SRC_MASK))->get_u32masked_value_as_addr();
	};
	caddress_in4 get_nw_src_value() const {
	 return static_cast<const coxmatch_32*>(matches.get_match(rofl::openflow::experimental::OXM_TLV_EXPR_NW_SRC_MASK))->get_u32value_as_addr();
	};
	caddress_in4 get_nw_src_mask() const {
	 return static_cast<const coxmatch_32*>(matches.get_match(rofl::openflow::experimental::OXM_TLV_EXPR_NW_SRC_MASK))->get_u32mask_as_addr();
	};
	caddress_in4 get_nw_dst() const {
	 return static_cast<const coxmatch_32*>(matches.get_match(rofl::openflow::experimental::OXM_TLV_EXPR_NW_DST_MASK))->get_u32masked_value_as_addr();
	};
	caddress_in4 get_nw_dst_value() const {
	 return static_cast<const coxmatch_32*>(matches.get_match(rofl::openflow::experimental::OXM_TLV_EXPR_NW_DST_MASK))->get_u32value_as_addr();
	};
	caddress_in4 get_nw_dst_mask() const {
	 return static_cast<const coxmatch_32*>(matches.get_match(rofl::openflow::experimental::OXM_TLV_EXPR_NW_DST_MASK))->get_u32mask_as_addr();
	};
	uint16_t get_tp_src() const {
	 return static_cast<const coxmatch_16*>(matches.get_match(rofl::openflow::experimental::OXM_TLV_EXPR_TP_SRC))->get_u16value();
	};
	uint16_t get_tp_dst() const {
	 return static_cast<const coxmatch_16*>(matches.get_match(rofl::openflow::experimental::OXM_TLV_EXPR_TP_DST))->get_u16value();
	};

	// OF12
	uint32_t get_in_port() const {
	 return static_cast<const coxmatch_32*>(matches.get_match(OXM_TLV_BASIC_IN_PORT))->get_u32value();
	};
	uint32_t get_in_phy_port() const {
	 return static_cast<const coxmatch_32*>(matches.get_match(OXM_TLV_BASIC_IN_PHY_PORT))->get_u32value();
	};
	uint64_t get_metadata() const {
	 return static_cast<const coxmatch_64*>(matches.get_match(OXM_TLV_BASIC_METADATA))->get_u64masked_value();
	};
	...
	uint32_t get_mpls_label() const {
	 return static_cast<const coxmatch_32*>(matches.get_match(OXM_TLV_BASIC_MPLS_LABEL))->get_u32value();
	};
	...
	uint8_t  get_ip_dscp() const {
	 return static_cast<const coxmatch_8*>(matches.get_match(OXM_TLV_BASIC_IP_DSCP))->get_u8value();
	};
	uint8_t  get_ip_ecn() const {
	 return static_cast<const coxmatch_8*>(matches.get_match(OXM_TLV_BASIC_IP_ECN))->get_u8value();
	};
	uint8_t  get_icmpv4_type() const {
	 return static_cast<const coxmatch_8*>(matches.get_match(OXM_TLV_BASIC_ICMPV4_TYPE))->get_u8value();
	};
	uint8_t  get_icmpv4_code() const {
	 return static_cast<const coxmatch_8*>(matches.get_match(OXM_TLV_BASIC_ICMPV4_CODE))->get_u8value();
	};
	uint8_t  get_icmpv6_type() const {
	 return static_cast<const coxmatch_8*>(matches.get_match(OXM_TLV_BASIC_ICMPV6_TYPE))->get_u8value();
	};
	...
	uint16_t get_udp_dst() const {
	 return static_cast<const coxmatch_16*>(matches.get_match(OXM_TLV_BASIC_UDP_DST))->get_u16value();
	};
	uint16_t get_tcp_src() const {
	 return static_cast<const coxmatch_16*>(matches.get_match(OXM_TLV_BASIC_TCP_SRC))->get_u16value();
	};
	uint16_t get_tcp_dst() const {
	 return static_cast<const coxmatch_16*>(matches.get_match(OXM_TLV_BASIC_TCP_DST))->get_u16value();
	};
	uint16_t get_sctp_src() const {
	 return static_cast<const coxmatch_16*>(matches.get_match(OXM_TLV_BASIC_SCTP_SRC))->get_u16value();
	};
	uint16_t get_sctp_dst() const {
	 return static_cast<const coxmatch_16*>(matches.get_match(OXM_TLV_BASIC_SCTP_DST))->get_u16value();
	};
	...
	void set_nw_proto(uint8_t proto) {
		matches.add_match(new coxmatch_ofx_nw_proto(proto));
	};
	void set_nw_tos(uint8_t tos) {
		matches.add_match(new coxmatch_ofx_nw_tos(tos));
	};
	...
	void set_tp_dst(uint16_t dst_port) {
		matches.add_match(new coxmatch_ofx_tp_dst(dst_port));
	};

	// OF12
	void set_in_port(uint32_t in_port) {
		matches.add_match(new coxmatch_ofb_in_port(in_port));
	};
	void set_in_phy_port(uint32_t in_phy_port) {
		matches.add_match(new coxmatch_ofb_in_phy_port(in_phy_port));
	};
	...
	void set_vlan_untagged() {
		matches.add_match(new coxmatch_ofb_vlan_untagged());
	};
	void set_vlan_pcp(uint8_t pcp) {
		matches.add_match(new coxmatch_ofb_vlan_pcp(pcp));
	};
	void set_ip_dscp(uint8_t dscp) {
		matches.add_match(new coxmatch_ofb_ip_dscp(dscp));
	};
	void set_ip_ecn(uint8_t ecn) {
		matches.add_match(new coxmatch_ofb_ip_ecn(ecn));
	};
	void set_ip_proto(uint8_t proto) {
		matches.add_match(new coxmatch_ofb_ip_proto(proto));
	};
	...
	void set_tcp_dst(uint16_t dst_port) {
		matches.add_match(new coxmatch_ofb_tcp_dst(dst_port));
	};
	void set_udp_src(uint16_t src_port) {
		matches.add_match(new coxmatch_ofb_udp_src(src_port));
	};
	void set_udp_dst(uint16_t dst_port) {
		matches.add_match(new coxmatch_ofb_udp_dst(dst_port));
	};
	void set_sctp_src(uint16_t src_port) {
		matches.add_match(new coxmatch_ofb_sctp_src(src_port));
	};
	void set_sctp_dst(uint16_t dst_port) {
		matches.add_match(new coxmatch_ofb_sctp_dst(dst_port));
	};
	void set_icmpv4_type(uint8_t type) {
		matches.add_match(new coxmatch_ofb_icmpv4_type(type));
	};
	void set_icmpv4_code(uint8_t code) {
		matches.add_match(new coxmatch_ofb_icmpv4_code(code));
	};
	void set_arp_opcode(uint16_t opcode) {
		matches.add_match(new coxmatch_ofb_arp_opcode(opcode));
	};
	...
	void set_icmpv6_code(uint8_t code) {
		matches.add_match(new coxmatch_ofb_icmpv6_code(code));
	};
	void set_ipv6_nd_target(const caddress_in6& addr) {
		matches.add_match(new coxmatch_ofb_ipv6_nd_target(addr));
	};
	void set_ipv6_nd_sll(const cmacaddr& maddr) {
		matches.add_match(new coxmatch_ofb_ipv6_nd_sll(maddr));
	};
	void set_ipv6_nd_tll(const cmacaddr& maddr) {
		matches.add_match(new coxmatch_ofb_ipv6_nd_tll(maddr));
	};
	void set_mpls_label(uint32_t label) {
		matches.add_match(new coxmatch_ofb_mpls_label(label));
	};
	void set_mpls_tc(uint8_t tc) {
		matches.add_match(new coxmatch_ofb_mpls_tc(tc));
	};

	// OF13
	void set_mpls_bos(bool bos) {
		matches.add_match(new coxmatch_ofb_mpls_bos(bos));
	};
