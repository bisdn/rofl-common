...
public:
	...
	uint8_t  get_nw_tos() const {
		return matches.get_ofx_nw_tos().get_u8value();
	};
	caddress_in4 get_nw_src() const {
		rofl::caddress_in4 addr; addr.set_addr_hbo(matches.get_ofx_nw_src().get_u32masked_value()); return addr;
	};
	caddress_in4 get_nw_src_value() const {
		rofl::caddress_in4 addr; addr.set_addr_hbo(matches.get_ofx_nw_src().get_u32value()); return addr;
	};
	caddress_in4 get_nw_src_mask() const {
		rofl::caddress_in4 addr; addr.set_addr_hbo(matches.get_ofx_nw_src().get_u32mask()); return addr;
	};
	caddress_in4 get_nw_dst() const {
		rofl::caddress_in4 addr; addr.set_addr_hbo(matches.get_ofx_nw_dst().get_u32masked_value()); return addr;
	};
	caddress_in4 get_nw_dst_value() const {
		rofl::caddress_in4 addr; addr.set_addr_hbo(matches.get_ofx_nw_dst().get_u32value()); return addr;
	};
	caddress_in4 get_nw_dst_mask() const {
		rofl::caddress_in4 addr; addr.set_addr_hbo(matches.get_ofx_nw_dst().get_u32mask()); return addr;
	};
	...
	uint8_t  get_ip_ecn() const {
		return matches.get_ofb_ip_ecn().get_u8value();
	};
	...
	void set_nw_proto(uint8_t proto) {
		matches.add_ofx_nw_proto(proto);
	};
	void set_nw_tos(uint8_t tos) {
		matches.add_ofx_nw_tos(tos);
	};
	void set_nw_src(const caddress_in4& src) {
		matches.add_ofx_nw_src(src);
	};
	...
	void set_tcp_src(uint16_t src_port) {
		matches.add_ofb_tcp_src(src_port);
	};
	void set_tcp_dst(uint16_t dst_port) {
		matches.add_ofb_tcp_dst(dst_port);
	};
	void set_udp_src(uint16_t src_port) {
		matches.add_ofb_udp_src(src_port);
	};
	void set_udp_dst(uint16_t dst_port) {
		matches.add_ofb_udp_dst(dst_port);
	};
	void set_sctp_src(uint16_t src_port) {
		matches.add_ofb_sctp_src(src_port);
	};
	void set_sctp_dst(uint16_t dst_port) {
		matches.add_ofb_sctp_dst(dst_port);
	};
	void set_icmpv4_type(uint8_t type) {
		matches.add_ofb_icmpv4_type(type);
	};
	void set_icmpv4_code(uint8_t code) {
		matches.add_ofb_icmpv4_code(code);
	};
	void set_arp_opcode(uint16_t opcode) {
		matches.add_ofb_arp_opcode(opcode);
	};
	...
	void set_icmpv6_type(uint8_t type) {
		matches.add_ofb_icmpv6_type(type);
	};
	void set_icmpv6_code(uint8_t code) {
		matches.add_ofb_icmpv6_code(code);
	};
	...
	void set_mpls_label(uint32_t label) {
		matches.add_ofb_mpls_label(label);
	};
	void set_mpls_tc(uint8_t tc) {
		matches.add_ofb_mpls_tc(tc);
	};

	// OF13
	void set_mpls_bos(bool bos) {
		matches.add_ofb_mpls_bos(bos);
	};
	...
	void set_pbb_isid(uint32_t pbb_isid) {
		matches.add_ofb_pbb_isid(pbb_isid);
	};
...
public:
	...
	bool has_nw_proto() const {
		return matches.has_ofx_nw_proto();
	};
	bool has_nw_tos() const {
		return matches.has_ofx_nw_tos();
	};
	...
	bool has_nw_src_mask() const {
		return (matches.has_ofx_nw_src() && matches.get_ofx_nw_src().get_oxm_hasmask());
	};
	...
	bool has_nw_dst_mask() const {
		return (matches.has_ofx_nw_dst() && matches.get_ofx_nw_dst().get_oxm_hasmask());
	};
	bool has_tp_src() const {
		return matches.has_ofx_tp_src();
	};
	bool has_tp_dst() const {
		return matches.has_ofx_tp_dst();
	};

	// OF12
	bool has_in_port() const {
		return matches.has_ofb_in_port();
	};
	bool has_in_phy_port() const {
		return matches.has_ofb_in_phy_port();
	};
	...
	bool has_metadata_mask() const {
		return (matches.has_ofb_metadata() && matches.get_ofb_metadata().get_oxm_hasmask());
	};
	...
	bool has_eth_dst_mask() const {
		return (matches.has_ofb_eth_dst() && matches.get_ofb_eth_dst().get_oxm_hasmask());
	};
	...
	bool has_eth_src_mask() const {
		return (matches.has_ofb_eth_src() && matches.get_ofb_eth_src().get_oxm_hasmask());
	};
	bool has_eth_type() const {
		return matches.has_ofb_eth_type();
	};
	...
	bool has_vlan_vid_mask() const {
		return (matches.has_ofb_vlan_vid() && matches.get_ofb_vlan_vid().get_oxm_hasmask());
	};
	bool has_vlan_pcp() const {
		return matches.has_ofb_vlan_pcp();
	};
	bool has_mpls_label() const {
		return matches.has_ofb_mpls_label();
	};
	bool has_mpls_tc() const {
		return matches.has_ofb_mpls_tc();
	};
	...
	bool has_ipv4_src_mask() const {
		return (matches.has_ofb_ipv4_src() && matches.get_ofb_ipv4_src().get_oxm_hasmask());
	};
	...
	bool has_ipv4_dst_mask() const {
		return (matches.has_ofb_ipv4_dst() && matches.get_ofb_ipv4_dst().get_oxm_hasmask());
	};
	bool has_arp_opcode() const {
		return matches.has_ofb_arp_opcode();
	};
	...
	bool has_arp_sha_mask() const {
		return (matches.has_ofb_arp_sha() && matches.get_ofb_arp_sha().get_oxm_hasmask());
	};
	...
	bool has_arp_tha_mask() const {
		return (matches.has_ofb_arp_tha() && matches.get_ofb_arp_tha().get_oxm_hasmask());
	};
	...
	bool has_arp_spa_mask() const {
		return (matches.has_ofb_arp_spa() && matches.get_ofb_arp_spa().get_oxm_hasmask());
	};
	...
	bool has_arp_tpa_mask() const {
		return (matches.has_ofb_arp_tpa() && matches.get_ofb_arp_tpa().get_oxm_hasmask());
	};
	...
	bool has_ipv6_src_mask() const {
		return (matches.has_ofb_ipv6_src() && matches.get_ofb_ipv6_src().get_oxm_hasmask());
	};
	...
	bool has_ipv6_dst_mask() const {
		return (matches.has_ofb_ipv6_dst() && matches.get_ofb_ipv6_dst().get_oxm_hasmask());
	};
	bool has_ip_proto() const {
		return matches.has_ofb_ip_proto();
	};
	bool has_ip_dscp() const {
		return matches.has_ofb_ip_dscp();
	};
	bool has_ip_ecn() const {
		return matches.has_ofb_ip_ecn();
	};
	bool has_icmpv4_type() const {
		return matches.has_ofb_icmpv4_type();
	};
	bool has_icmpv4_code() const {
		return matches.has_ofb_icmpv4_code();
	};
	bool has_icmpv6_type() const {
		return matches.has_ofb_icmpv6_type();
	};
	bool has_icmpv6_code() const {
		return matches.has_ofb_icmpv6_code();
	};
	...
	bool has_ipv6_flabel_mask() const {
		return (matches.has_ofb_ipv6_flabel() && matches.get_ofb_ipv6_flabel().get_oxm_hasmask());
	};
	bool has_ipv6_nd_sll() const {
		return matches.has_ofb_ipv6_nd_sll();
	};
	bool has_ipv6_nd_tll() const {
		return matches.has_ofb_ipv6_nd_tll();
	};
	bool has_ipv6_nd_target() const {
		return matches.has_ofb_ipv6_nd_target();
	};
	bool has_udp_src() const {
		return matches.has_ofb_udp_src();
	};
	bool has_udp_dst() const {
		return matches.has_ofb_udp_dst();
	};
	bool has_tcp_src() const {
		return matches.has_ofb_tcp_src();
	};
	bool has_tcp_dst() const {
		return matches.has_ofb_tcp_dst();
	};
	bool has_sctp_src() const {
		return matches.has_ofb_sctp_src();
	};
	bool has_sctp_dst() const {
		return matches.has_ofb_sctp_dst();
	};

	// OF13
	bool     has_mpls_bos() const {
		return matches.has_ofb_mpls_bos();
	};
	...
	bool has_tunnel_id_mask() const {
		return (matches.has_ofb_tunnel_id() && matches.get_ofb_tunnel_id().get_oxm_hasmask());
	};
	...
	bool has_pbb_isid_mask() const {
		return (matches.has_ofb_pbb_isid() && matches.get_ofb_pbb_isid().get_oxm_hasmask());
	};
	...
	bool has_ipv6_exthdr_mask() const {
		return (matches.has_ofb_ipv6_exthdr() && matches.get_ofb_ipv6_exthdr().get_oxm_hasmask());
	};
};
